...
class testSelfPointingNode(FlowTestsBase):
    ...
    def test_self_pointing_node(self):
        ...
        self.env.assertEqual(len(result_a.result_set), 1)
        ...
        self.env.assertEqual(result_f.result_set, result_a.result_set)

        self.env.assertContains("Expand Into", plan_a)
        self.env.assertContains("Expand Into", plan_b)
        self.env.assertContains("Expand Into", plan_c)
        self.env.assertContains("Expand Into", plan_d)
        self.env.assertContains("Expand Into", plan_e)
        self.env.assertContains("Expand Into", plan_f)
