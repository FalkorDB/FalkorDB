...
class testUndoLog():
    ...
    def test05_undo_update_node(self):
        ...
        self.env.assertEqual(n_v0, n_v2)

        # no new properties should have been created
        property_keys_v2 = self.graph.query("CALL db.propertyKeys").result_set
        self.env.assertEqual(property_keys_v0, property_keys_v2)
        ...
        self.env.assertEqual(n_v0, n_v3)

        property_keys_v3 = self.graph.query("CALL db.propertyKeys").result_set
        self.env.assertEqual(property_keys_v0, property_keys_v3)
        ...
        self.env.assertEqual(n_v0, n_v4)

        property_keys_v4 = self.graph.query("CALL db.propertyKeys").result_set
        self.env.assertEqual(property_keys_v0, property_keys_v4)
    ...
    def test06_undo_update_edge(self):
        ...
        self.env.assertEqual(property_keys, new_property_keys)
        ...
        self.env.assertEqual(result.result_set, [[None]])
    ...
    def test15_complex_undo(self):
        ...
        try:
            ...
            self.env.assertEqual(str(e), "Type mismatch: expected Integer, Float, or Null but was String")
    ...
    def test16_undo_remove_label(self):
        ...
        self.env.assertEqual(len(result.result_set), 1)
        self.env.assertEqual(["L2"], result.result_set[0][0])
        # check index is ok
    ...
    def test17_undo_set_remove_label(self):
        ...
        self.env.assertEqual(len(result.result_set), 1)
        self.env.assertEqual(["L3"], result.result_set[0][0])
    ...
    def test18_undo_remove_set_label(self):
        ...
        self.env.assertEqual(len(result.result_set), 1)
        self.env.assertEqual(["L4"], result.result_set[0][0])
