...
class testSlowLog():
    ...
    def test03_cap_entry(self):
        ...
        long_string = 'a' * 4000
        query = f"WITH '{long_string}' AS str UNWIND range(0, 100000) AS x RETURN count(x)"
        ...
        query = "WITH $long_string AS str UNWIND range(0, 100000) AS x RETURN count(x)"
        ...
        query = f"WITH $long_string as long_param, '{long_string}' AS long_string UNWIND range(0, 100000) AS x RETURN count(x)"
        self.graph.query(query, {'long_string': long_string})
    ...
    def test04_same_query_diff_params(self):
        ...
        self.graph.query(query, {'i': 100000})
