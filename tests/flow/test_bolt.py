...
class testBolt():
    ...
    def test03_parameters(self):
        with bolt_con.session() as session:
            result = session.run("""RETURN $v1, $v2, $v3, $v4, $v5, $v6, $v7, $v8, $v9, $v10, $v11, $v12, $v13, $v14, $v15, $v16, $v17, $v18, $v19, $v20, $v21""", {"v1": None, "v2": True, "v3": False, "v4": -1, "v5": 0, "v6": 1, "v7": 2, "v8": 255, "v9": 256, "v10": 257, "v11": 65535, "v12": 65536, "v13": 65537, "v14": 4294967295, "v15": 4294967296, "v16": 4294967297, "v17": 9223372036854775807, "v18": 1.23, "v19": 'Hello, World!', "v20": [1,2,3], "v21": {'foo':'bar'}})
            record = result.single()
            self.env.assertEquals(record[0], None)
            self.env.assertEquals(record[1], True)
            self.env.assertEquals(record[2], False)
