...
pub struct Pending {
    ...
    pub(crate) created_rels_by_type: FxHashMap<Arc<String>, Vec<RelationshipId>>,
    /// Reverse index: rel_id → type and endpoints, for O(1) existence, type
    /// and endpoint lookups.
    pub(crate) created_rel_types: FxHashMap<RelationshipId, CreatedRel>,
    /// Nodes to be deleted
