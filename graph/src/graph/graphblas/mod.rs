...
// bindgen --default-enum-style=rust --allowlist-file /usr/local/include/suitesparse/GraphBLAS.h /usr/local/include/suitesparse/GraphBLAS.h -o graph/src/graphblas/mod.rs
...
pub const GxB_IMPLEMENTATION_DATE: &[u8; 13] = b"Mar 20, 2025\0";
