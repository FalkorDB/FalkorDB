//------------------------------------------------------------------------------
// GB_jit__subassign_05__07e0207f00026950.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__subassign_05__07e0207f00026950
#define GB_jit_query  GB_jit__subassign_05__07e0207f00026950_query
#endif
#include "template/GB_jit_kernel_subassign_05.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x0553fcc45be00869 ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
