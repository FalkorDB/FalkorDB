//------------------------------------------------------------------------------
// GB_jit__subassign_01__08006c7f000016cc.c
//------------------------------------------------------------------------------
...
#define GB_COPY_scalar_to_cwork(cwork,scalar) cwork = (((*((GB_A_TYPE *) scalar))) != 0)
...
#define GB_jit_kernel GB_jit__subassign_01__08006c7f000016cc
#define GB_jit_query  GB_jit__subassign_01__08006c7f000016cc_query
#endif
#include "template/GB_jit_kernel_subassign_01.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x45354f5d2c3dad15 ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
