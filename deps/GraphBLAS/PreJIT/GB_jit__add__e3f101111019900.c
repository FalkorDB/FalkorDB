//------------------------------------------------------------------------------
// GB_jit__add__e3f101111019900.c
//------------------------------------------------------------------------------
...
#define GB_COPY_B_to_C(Cx,pC,Bx,pB,B_iso) Cx [pC] = ((Bx [0]) != 0)
...
#define GB_GETB(b,Bx,p,iso) b = ((Bx [0]) != 0)
...
#define GB_jit_kernel GB_jit__add__e3f101111019900
#define GB_jit_query  GB_jit__add__e3f101111019900_query
#endif
#include "template/GB_jit_kernel_add.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x62825631a06539b2 ;
    v [0] = 10 ; v [1] = 0 ; v [2] = 2 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
