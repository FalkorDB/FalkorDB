//------------------------------------------------------------------------------
// GB_jit__AxB_saxpy4__0380000e1e0e1ec6__lg_hll_merge_lg_hll_second.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__AxB_saxpy4__0380000e1e0e1ec6__lg_hll_merge_lg_hll_second
#define GB_jit_query  GB_jit__AxB_saxpy4__0380000e1e0e1ec6__lg_hll_merge_lg_hll_second_query
#endif
#include "template/GB_jit_kernel_AxB_saxpy4.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x26687fb9c9b031b1 ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
