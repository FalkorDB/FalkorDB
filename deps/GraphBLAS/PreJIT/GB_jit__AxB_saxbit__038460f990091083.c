//------------------------------------------------------------------------------
// GB_jit__AxB_saxbit__038460f990091083.c
//------------------------------------------------------------------------------
...
#define GB_GETA(a,Ax,p,iso) a = (uint64_t) (Ax [0])
...
#define GB_jit_kernel GB_jit__AxB_saxbit__038460f990091083
#define GB_jit_query  GB_jit__AxB_saxbit__038460f990091083_query
#endif
#include "template/GB_jit_kernel_AxB_saxbit.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0xa9f46b2c911a72bd ;
    v [0] = 10 ; v [1] = 0 ; v [2] = 2 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
