//------------------------------------------------------------------------------
// GB_jit__select_phase1__3f3318e85__LG_MSF_selectEdge_int.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__select_phase1__3f3318e85__LG_MSF_selectEdge_int
#define GB_jit_query  GB_jit__select_phase1__3f3318e85__LG_MSF_selectEdge_int_query
#endif
#include "template/GB_jit_kernel_select_phase1.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0xc65054e0c1ae7f8a ;
    v [0] = 10 ; v [1] = 4 ; v [2] = 0 ;
