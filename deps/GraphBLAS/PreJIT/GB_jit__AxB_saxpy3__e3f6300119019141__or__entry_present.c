//------------------------------------------------------------------------------
// GB_jit__AxB_saxpy3__e3f6300119019141__or__entry_present.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__AxB_saxpy3__e3f6300119019141__or__entry_present
#define GB_jit_query  GB_jit__AxB_saxpy3__e3f6300119019141__or__entry_present_query
#endif
#include "template/GB_jit_kernel_AxB_saxpy3.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x5632b44c5db02e45 ;
    v [0] = 10 ; v [1] = 0 ; v [2] = 2 ;
    defn [0] = NULL ;
