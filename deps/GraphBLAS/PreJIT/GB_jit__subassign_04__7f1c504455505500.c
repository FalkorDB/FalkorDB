//------------------------------------------------------------------------------
// GB_jit__subassign_04__7f1c504455505500.c
//------------------------------------------------------------------------------
...
#define GB_DECLAREZ(zwork) uint16_t zwork
#define GB_DECLAREX(xwork) uint16_t xwork
#define GB_DECLAREY(ywork) uint16_t ywork
...
#define GB_jit_kernel GB_jit__subassign_04__7f1c504455505500
#define GB_jit_query  GB_jit__subassign_04__7f1c504455505500_query
#endif
#include "template/GB_jit_kernel_subassign_04.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x7df412547795355f ;
    v [0] = 10 ; v [1] = 0 ; v [2] = 2 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
