//------------------------------------------------------------------------------
// GB_jit__ewise_fulln__000000bee0beecf__fdb_hll_delta.c
//------------------------------------------------------------------------------
...
// op: fdb_hll_delta, ztype: double, xtype: HLL, ytype: HLL
...
#define GB_jit_kernel GB_jit__ewise_fulln__000000bee0beecf__fdb_hll_delta
#define GB_jit_query  GB_jit__ewise_fulln__000000bee0beecf__fdb_hll_delta_query
#endif
#include "template/GB_jit_kernel_ewise_fulln.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x60c355eee40410b4 ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
    defn [0] = GB_fdb_hll_delta_USER_DEFN ;
    defn [1] = NULL ;
    defn [2] = NULL ;
