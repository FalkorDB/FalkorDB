//------------------------------------------------------------------------------
// GB_jit__apply_unop__03c000eb0e9d__LG_MF_ResidualBackward.c
//------------------------------------------------------------------------------
...
// op: LG_MF_ResidualBackward, ztype: LG_MF_flowEdge, xtype: double, ytype: void
...
// unary operator:
#ifndef GB_GUARD_LG_MF_ResidualBackward_DEFINED
#define GB_GUARD_LG_MF_ResidualBackward_DEFINED
GB_STATIC_INLINE
void LG_MF_ResidualBackward(LG_MF_flowEdge *z, const double *y) { z->capacity = 0; z->flow = 0; }
#define GB_LG_MF_ResidualBackward_USER_DEFN \
"void LG_MF_ResidualBackward(LG_MF_flowEdge *z, const double *y) { z->capacity = 0; z->flow = 0; }"
#endif
#define GB_UNARYOP(z,x,i,j,y)  LG_MF_ResidualBackward (&(z), &(x))
...
#define GB_GETA(a,Ax,p,iso) a = (double) (Ax [p])
...
#define GB_jit_kernel GB_jit__apply_unop__03c000eb0e9d__LG_MF_ResidualBackward
#define GB_jit_query  GB_jit__apply_unop__03c000eb0e9d__LG_MF_ResidualBackward_query
#endif
#include "template/GB_jit_kernel_apply_unop.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0xbb9b31ff378560e4 ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
    defn [0] = GB_LG_MF_ResidualBackward_USER_DEFN ;
    defn [1] = NULL ;
