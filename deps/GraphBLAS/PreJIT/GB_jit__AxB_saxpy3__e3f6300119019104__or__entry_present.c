//------------------------------------------------------------------------------
// GB_jit__AxB_saxpy3__e3f6300119019104__or__entry_present.c
//------------------------------------------------------------------------------
...
// semiring: (or, _entry_present (flipped), bool)
...
#define GB_Z_CUDA_ATOMIC GB_cuda_atomic_bor
#define GB_Z_CUDA_ATOMIC_TYPE uint32_t

// multiplicative operator (flipped):
#define GB_X_TYPE bool
#define GB_Y_TYPE uint64_t
#ifndef GB_GUARD__entry_present_DEFINED
#define GB_GUARD__entry_present_DEFINED
GB_STATIC_INLINE
...
#define GB_jit_kernel GB_jit__AxB_saxpy3__e3f6300119019104__or__entry_present
#define GB_jit_query  GB_jit__AxB_saxpy3__e3f6300119019104__or__entry_present_query
#endif
#include "template/GB_jit_kernel_AxB_saxpy3.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x000f7be669e4253f ;
    v [0] = 10 ; v [1] = 0 ; v [2] = 2 ;
    defn [0] = NULL ;
    defn [1] = GB__entry_present_USER_DEFN ;
    defn [2] = NULL ;
    defn [3] = NULL ;
    defn [4] = NULL ;
    return (true) ;
