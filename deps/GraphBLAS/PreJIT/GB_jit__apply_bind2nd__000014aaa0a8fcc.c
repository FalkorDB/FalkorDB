//------------------------------------------------------------------------------
// GB_jit__apply_bind2nd__000014aaa0a8fcc.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__apply_bind2nd__000014aaa0a8fcc
#define GB_jit_query  GB_jit__apply_bind2nd__000014aaa0a8fcc_query
#endif
#include "template/GB_jit_kernel_apply_bind2nd.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0xf9842e0bcfa797bd ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 0 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
