//------------------------------------------------------------------------------
// GB_jit__subref_bitmap__08084ba.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__subref_bitmap__08084ba
#define GB_jit_query  GB_jit__subref_bitmap__08084ba_query
#endif
#include "template/GB_jit_kernel_subref_bitmap.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x4323edc6ffe2d859 ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
