//------------------------------------------------------------------------------
// GB_jit__subref_bitmap__08000ef__LG_MSF_tuple_int.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__subref_bitmap__08000ef__LG_MSF_tuple_int
#define GB_jit_query  GB_jit__subref_bitmap__08000ef__LG_MSF_tuple_int_query
#endif
#include "template/GB_jit_kernel_subref_bitmap.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x4984df75f5ce97ef ;
    v [0] = 10 ; v [1] = 4 ; v [2] = 0 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
