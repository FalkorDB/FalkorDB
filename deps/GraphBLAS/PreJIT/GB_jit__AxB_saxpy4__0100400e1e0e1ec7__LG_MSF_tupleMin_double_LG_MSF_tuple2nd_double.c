//------------------------------------------------------------------------------
// GB_jit__AxB_saxpy4__0100400e1e0e1ec7__LG_MSF_tupleMin_double_LG_MSF_tuple2nd_double.c
//------------------------------------------------------------------------------
...
// semiring: (LG_MSF_tupleMin_double, LG_MSF_tuple2nd_double, bool)
...
#ifndef GB_GUARD_LG_MSF_tuple2nd_double_DEFINED
#define GB_GUARD_LG_MSF_tuple2nd_double_DEFINED
GB_STATIC_INLINE
void LG_MSF_tuple2nd_double ( LG_MSF_tuple_double *z, const void *x, const LG_MSF_tuple_double *y ) { z->wInt = y->wInt; z->idx = y->idx; }
#define GB_LG_MSF_tuple2nd_double_USER_DEFN \
"void LG_MSF_tuple2nd_double ( LG_MSF_tuple_double *z, const void *x, const LG_MSF_tuple_double *y ) { z->wInt = y->wInt; z->idx = y->idx; }"
#endif
#define GB_MULT(z,x,y,i,k,j)  LG_MSF_tuple2nd_double (&(z), &(x), &(y))
...
#define GB_B_ISO 0
#define GB_B_TYPE LG_MSF_tuple_double
#define GB_B2TYPE LG_MSF_tuple_double
#define GB_DECLAREB(b) LG_MSF_tuple_double b
...
#define GB_jit_kernel GB_jit__AxB_saxpy4__0100400e1e0e1ec7__LG_MSF_tupleMin_double_LG_MSF_tuple2nd_double
#define GB_jit_query  GB_jit__AxB_saxpy4__0100400e1e0e1ec7__LG_MSF_tupleMin_double_LG_MSF_tuple2nd_double_query
#endif
#include "template/GB_jit_kernel_AxB_saxpy4.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0xa4c45ee51248efba ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
    defn [0] = GB_LG_MSF_tupleMin_double_USER_DEFN ;
    defn [1] = GB_LG_MSF_tuple2nd_double_USER_DEFN ;
