//------------------------------------------------------------------------------
// GB_jit__emult_bitmap__000214bbb2bbbaf.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__emult_bitmap__000214bbb2bbbaf
#define GB_jit_query  GB_jit__emult_bitmap__000214bbb2bbbaf_query
#endif
#include "template/GB_jit_kernel_emult_bitmap.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0xab359fc167fdec0a ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
