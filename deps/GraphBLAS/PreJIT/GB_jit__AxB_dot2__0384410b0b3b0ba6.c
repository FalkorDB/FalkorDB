//------------------------------------------------------------------------------
// GB_jit__AxB_dot2__0384410b0b3b0ba6.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__AxB_dot2__0384410b0b3b0ba6
#define GB_jit_query  GB_jit__AxB_dot2__0384410b0b3b0ba6_query
#endif
#include "template/GB_jit_kernel_AxB_dot2.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x60192d41750801f0 ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 0 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
