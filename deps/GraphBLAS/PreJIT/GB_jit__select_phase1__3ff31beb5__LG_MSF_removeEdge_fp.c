//------------------------------------------------------------------------------
// GB_jit__select_phase1__3ff31beb5__LG_MSF_removeEdge_fp.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__select_phase1__3ff31beb5__LG_MSF_removeEdge_fp
#define GB_jit_query  GB_jit__select_phase1__3ff31beb5__LG_MSF_removeEdge_fp_query
#endif
#include "template/GB_jit_kernel_select_phase1.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0xc2f8f6416a7c95c3 ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 0 ;
