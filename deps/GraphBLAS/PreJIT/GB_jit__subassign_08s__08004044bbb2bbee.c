//------------------------------------------------------------------------------
// GB_jit__subassign_08s__08004044bbb2bbee.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__subassign_08s__08004044bbb2bbee
#define GB_jit_query  GB_jit__subassign_08s__08004044bbb2bbee_query
#endif
#include "template/GB_jit_kernel_subassign_08s.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x34a20028bc3e0c8c ;
    v [0] = 10 ; v [1] = 4 ; v [2] = 0 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
