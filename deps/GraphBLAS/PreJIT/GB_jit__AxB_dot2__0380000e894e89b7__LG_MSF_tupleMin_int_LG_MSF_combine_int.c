//------------------------------------------------------------------------------
// GB_jit__AxB_dot2__0380000e894e89b7__LG_MSF_tupleMin_int_LG_MSF_combine_int.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__AxB_dot2__0380000e894e89b7__LG_MSF_tupleMin_int_LG_MSF_combine_int
#define GB_jit_query  GB_jit__AxB_dot2__0380000e894e89b7__LG_MSF_tupleMin_int_LG_MSF_combine_int_query
#endif
#include "template/GB_jit_kernel_AxB_dot2.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0xaf9c29c3febb7023 ;
    v [0] = 10 ; v [1] = 4 ; v [2] = 0 ;
