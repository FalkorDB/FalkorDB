//------------------------------------------------------------------------------
// GB_jit__subref_sparse__0bf0491.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__subref_sparse__0bf0491
#define GB_jit_query  GB_jit__subref_sparse__0bf0491_query
#endif
#include "template/GB_jit_kernel_subref_sparse.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0xcaa2a173ec93573e ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
