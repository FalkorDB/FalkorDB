//------------------------------------------------------------------------------
// GB_jit__subassign_04__7f1c4140eee0ee45__LG_MF_InitForw.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__subassign_04__7f1c4140eee0ee45__LG_MF_InitForw
#define GB_jit_query  GB_jit__subassign_04__7f1c4140eee0ee45__LG_MF_InitForw_query
#endif
#include "template/GB_jit_kernel_subassign_04.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x96e8c7e4d44124a6 ;
    v [0] = 10 ; v [1] = 4 ; v [2] = 0 ;
