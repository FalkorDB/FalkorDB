//------------------------------------------------------------------------------
// GB_jit__subassign_01__08026c7f000099cc.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__subassign_01__08026c7f000099cc
#define GB_jit_query  GB_jit__subassign_01__08026c7f000099cc_query
#endif
#include "template/GB_jit_kernel_subassign_01.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0xf949e19f6fd0860d ;
    v [0] = 10 ; v [1] = 4 ; v [2] = 0 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
