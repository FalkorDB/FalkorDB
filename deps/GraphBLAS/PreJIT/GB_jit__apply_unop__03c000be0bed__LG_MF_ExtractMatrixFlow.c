//------------------------------------------------------------------------------
// GB_jit__apply_unop__03c000be0bed__LG_MF_ExtractMatrixFlow.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__apply_unop__03c000be0bed__LG_MF_ExtractMatrixFlow
#define GB_jit_query  GB_jit__apply_unop__03c000be0bed__LG_MF_ExtractMatrixFlow_query
#endif
#include "template/GB_jit_kernel_apply_unop.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0xb32759be2855865a ;
    v [0] = 10 ; v [1] = 4 ; v [2] = 0 ;
