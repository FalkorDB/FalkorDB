//------------------------------------------------------------------------------
// GB_jit__add__00000288808288a.c
//------------------------------------------------------------------------------
...
// binary operator:
#define GB_BINOP(z,x,y,i,j) z = (((x) < (y)) ? (x) : (y))
#define GB_COPY_A_to_C(Cx,pC,Ax,pA,A_iso) Cx [pC] = (int64_t) Ax [pA]
...
#define GB_DECLAREB(b) int64_t b
...
#define GB_jit_kernel GB_jit__add__00000288808288a
#define GB_jit_query  GB_jit__add__00000288808288a_query
#endif
#include "template/GB_jit_kernel_add.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0xda81a071e2e559bf ;
    v [0] = 10 ; v [1] = 0 ; v [2] = 2 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
