//------------------------------------------------------------------------------
// GB_jit__subassign_02__7f02447f00009b47.c
//------------------------------------------------------------------------------
...
#endif
#define GB_COPY_A_to_C(Cx,pC,Ax,pA,A_iso) Cx [pC] = GJ_cast_to_uint64 (Ax [pA])
...
#endif
#define GB_COPY_aij_to_cwork(cwork,Ax,p,A_iso) cwork = GJ_cast_to_uint64 (Ax [p])
...
#define GB_jit_kernel GB_jit__subassign_02__7f02447f00009b47
#define GB_jit_query  GB_jit__subassign_02__7f02447f00009b47_query
#endif
#include "template/GB_jit_kernel_subassign_02.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0xae842d0df7154869 ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
