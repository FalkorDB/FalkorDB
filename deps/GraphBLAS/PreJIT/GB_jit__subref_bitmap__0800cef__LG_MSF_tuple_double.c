//------------------------------------------------------------------------------
// GB_jit__subref_bitmap__0800cef__LG_MSF_tuple_double.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__subref_bitmap__0800cef__LG_MSF_tuple_double
#define GB_jit_query  GB_jit__subref_bitmap__0800cef__LG_MSF_tuple_double_query
#endif
#include "template/GB_jit_kernel_subref_bitmap.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x0f6139e70dbd98ec ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
