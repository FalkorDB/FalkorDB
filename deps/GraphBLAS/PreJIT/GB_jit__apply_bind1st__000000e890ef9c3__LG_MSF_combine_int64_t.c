//------------------------------------------------------------------------------
// GB_jit__apply_bind1st__000000e890ef9c3__LG_MSF_combine_int64_t.c
//------------------------------------------------------------------------------
...
// op: LG_MSF_combine_int64_t, ztype: LG_MSF_tuple_int64_t, xtype: int64_t, ytype: uint64_t
...
"void LG_MSF_combine_int64_t ( LG_MSF_tuple_int64_t *z, const int64_t *x, const uint64_t *y ) { z->wInt = *x; z->idx = *y; }"
#endif
#define GB_BINOP(z,x,y,i,j)  LG_MSF_combine_int64_t (&(z), &(x), &(y))
...
#define GB_jit_kernel GB_jit__apply_bind1st__000000e890ef9c3__LG_MSF_combine_int64_t
#define GB_jit_query  GB_jit__apply_bind1st__000000e890ef9c3__LG_MSF_combine_int64_t_query
#endif
#include "template/GB_jit_kernel_apply_bind1st.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x30ebaf9d52f69266 ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
    defn [0] = GB_LG_MSF_combine_int64_t_USER_DEFN ;
    defn [1] = NULL ;
