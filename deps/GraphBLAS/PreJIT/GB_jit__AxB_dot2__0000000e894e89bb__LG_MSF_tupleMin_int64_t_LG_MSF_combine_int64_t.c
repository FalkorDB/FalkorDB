//------------------------------------------------------------------------------
// GB_jit__AxB_dot2__0000000e894e89bb__LG_MSF_tupleMin_int64_t_LG_MSF_combine_int64_t.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__AxB_dot2__0000000e894e89bb__LG_MSF_tupleMin_int64_t_LG_MSF_combine_int64_t
#define GB_jit_query  GB_jit__AxB_dot2__0000000e894e89bb__LG_MSF_tupleMin_int64_t_LG_MSF_combine_int64_t_query
#endif
#include "template/GB_jit_kernel_AxB_dot2.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0xff1da3a3d893e6f8 ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
