//------------------------------------------------------------------------------
// GB_jit__subassign_15__08006043666369fc.c
//------------------------------------------------------------------------------
...
// subassign: C<!M,full,struct> max= scalar 
...
#define GB_jit_kernel GB_jit__subassign_15__08006043666369fc
#define GB_jit_query  GB_jit__subassign_15__08006043666369fc_query
#endif
#include "template/GB_jit_kernel_subassign_15.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x4d1dca4c0baa8f22 ;
    v [0] = 10 ; v [1] = 4 ; v [2] = 0 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
