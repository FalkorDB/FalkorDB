//------------------------------------------------------------------------------
// GB_jit__apply_unop__03c000be0bec__LG_MF_GetResidual.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__apply_unop__03c000be0bec__LG_MF_GetResidual
#define GB_jit_query  GB_jit__apply_unop__03c000be0bec__LG_MF_GetResidual_query
#endif
#include "template/GB_jit_kernel_apply_unop.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x15d28565273b7aeb ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
