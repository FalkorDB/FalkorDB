//------------------------------------------------------------------------------
// GB_jit__masker_phase2__1c004e9e__LG_MSF_tuple_double.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__masker_phase2__1c004e9e__LG_MSF_tuple_double
#define GB_jit_query  GB_jit__masker_phase2__1c004e9e__LG_MSF_tuple_double_query
#endif
#include "template/GB_jit_kernel_masker_phase2.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x8387b821135ba3c5 ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
