//------------------------------------------------------------------------------
// GB_jit__subassign_06n__07fc107f00029900.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__subassign_06n__07fc107f00029900
#define GB_jit_query  GB_jit__subassign_06n__07fc107f00029900_query
#endif
#include "template/GB_jit_kernel_subassign_06n.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x986a383b97187c02 ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 0 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
