//------------------------------------------------------------------------------
// GB_jit__add__000203aaa0aaace.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__add__000203aaa0aaace
#define GB_jit_query  GB_jit__add__000203aaa0aaace_query
#endif
#include "template/GB_jit_kernel_add.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x33cc5a4a7114c9bd ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 0 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
