//------------------------------------------------------------------------------
// GB_jit__bitmap_assign_2_whole__0000003f0002b8a2.c
//------------------------------------------------------------------------------
...
#define GB_COPY_A_to_C(Cx,pC,Ax,pA,A_iso) Cx [pC] = (double) Ax [pA]
#define GB_COPY_aij_to_C(Cx,pC,Ax,pA,A_iso,cwork,C_iso) \
    GB_COPY_A_to_C (Cx, pC, Ax, pA, A_iso)
#define GB_COPY_aij_to_cwork(cwork,Ax,p,A_iso) cwork = (double) (Ax [p])
...
#define GB_jit_kernel GB_jit__bitmap_assign_2_whole__0000003f0002b8a2
#define GB_jit_query  GB_jit__bitmap_assign_2_whole__0000003f0002b8a2_query
#endif
#include "template/GB_jit_kernel_bitmap_assign_2_whole.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0xcfe0a08732bc8c4e ;
    v [0] = 10 ; v [1] = 4 ; v [2] = 0 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
