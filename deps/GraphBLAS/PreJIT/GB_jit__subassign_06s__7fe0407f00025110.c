//------------------------------------------------------------------------------
// GB_jit__subassign_06s__7fe0407f00025110.c
//------------------------------------------------------------------------------
...
#define GB_DECLAREC(cwork) uint16_t cwork
#define GB_COPY_A_to_C(Cx,pC,Ax,pA,A_iso) Cx [pC] = (uint16_t) Ax [pA]
#define GB_COPY_aij_to_C(Cx,pC,Ax,pA,A_iso,cwork,C_iso) \
    GB_COPY_A_to_C (Cx, pC, Ax, pA, A_iso)
#define GB_COPY_aij_to_cwork(cwork,Ax,p,A_iso) cwork = (uint16_t) (Ax [p])
...
#define GB_jit_kernel GB_jit__subassign_06s__7fe0407f00025110
#define GB_jit_query  GB_jit__subassign_06s__7fe0407f00025110_query
#endif
#include "template/GB_jit_kernel_subassign_06s.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x6467fb8e659cca90 ;
    v [0] = 10 ; v [1] = 4 ; v [2] = 0 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
