//------------------------------------------------------------------------------
// GB_jit__subassign_01__0800647f000099cc.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__subassign_01__0800647f000099cc
#define GB_jit_query  GB_jit__subassign_01__0800647f000099cc_query
#endif
#include "template/GB_jit_kernel_subassign_01.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x3074596ef9368195 ;
    v [0] = 10 ; v [1] = 4 ; v [2] = 0 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
