//------------------------------------------------------------------------------
// GB_jit__AxB_saxpy4__0100400e1e0e1ec7__LG_MSF_tupleMin_int64_t_LG_MSF_tuple2nd_int64_t.c
//------------------------------------------------------------------------------
...
// semiring: (LG_MSF_tupleMin_int64_t, LG_MSF_tuple2nd_int64_t, bool)
...
#ifndef GB_GUARD_LG_MSF_tuple2nd_int64_t_DEFINED
#define GB_GUARD_LG_MSF_tuple2nd_int64_t_DEFINED
GB_STATIC_INLINE
void LG_MSF_tuple2nd_int64_t ( LG_MSF_tuple_int64_t *z, const void *x, const LG_MSF_tuple_int64_t *y ) { z->wInt = y->wInt; z->idx = y->idx; }
#define GB_LG_MSF_tuple2nd_int64_t_USER_DEFN \
"void LG_MSF_tuple2nd_int64_t ( LG_MSF_tuple_int64_t *z, const void *x, const LG_MSF_tuple_int64_t *y ) { z->wInt = y->wInt; z->idx = y->idx; }"
#endif
#define GB_MULT(z,x,y,i,k,j)  LG_MSF_tuple2nd_int64_t (&(z), &(x), &(y))
...
#define GB_jit_kernel GB_jit__AxB_saxpy4__0100400e1e0e1ec7__LG_MSF_tupleMin_int64_t_LG_MSF_tuple2nd_int64_t
#define GB_jit_query  GB_jit__AxB_saxpy4__0100400e1e0e1ec7__LG_MSF_tupleMin_int64_t_LG_MSF_tuple2nd_int64_t_query
#endif
#include "template/GB_jit_kernel_AxB_saxpy4.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0xb2bf1763f3d005fd ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
    defn [0] = GB_LG_MSF_tupleMin_int64_t_USER_DEFN ;
    defn [1] = GB_LG_MSF_tuple2nd_int64_t_USER_DEFN ;
