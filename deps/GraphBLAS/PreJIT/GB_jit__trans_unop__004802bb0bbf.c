//------------------------------------------------------------------------------
// GB_jit__trans_unop__004802bb0bbf.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__trans_unop__004802bb0bbf
#define GB_jit_query  GB_jit__trans_unop__004802bb0bbf_query
#endif
#include "template/GB_jit_kernel_trans_unop.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x316cc84ddef282af ;
    v [0] = 10 ; v [1] = 4 ; v [2] = 0 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
