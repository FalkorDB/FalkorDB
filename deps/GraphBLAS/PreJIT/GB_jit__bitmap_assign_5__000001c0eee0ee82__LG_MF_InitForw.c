//------------------------------------------------------------------------------
// GB_jit__bitmap_assign_5__000001c0eee0ee82__LG_MF_InitForw.c
//------------------------------------------------------------------------------
...
// accum: LG_MF_InitForw, ztype: LG_MF_flowEdge, xtype: LG_MF_flowEdge, ytype: LG_MF_flowEdge
...
// accum operator:
#ifndef GB_GUARD_LG_MF_InitForw_DEFINED
#define GB_GUARD_LG_MF_InitForw_DEFINED
GB_STATIC_INLINE
void LG_MF_InitForw(LG_MF_flowEdge * z, const LG_MF_flowEdge * x, const LG_MF_flowEdge * y){ z->capacity = x->capacity; z->flow = y->flow + x->flow; }
#define GB_LG_MF_InitForw_USER_DEFN \
"void LG_MF_InitForw(LG_MF_flowEdge * z, const LG_MF_flowEdge * x, const LG_MF_flowEdge * y){ z->capacity = x->capacity; z->flow = y->flow + x->flow; }"
#endif
#define GB_ACCUM_OP(z,x,y)  LG_MF_InitForw (&(z), &(x), &(y))
...
#define GB_jit_kernel GB_jit__bitmap_assign_5__000001c0eee0ee82__LG_MF_InitForw
#define GB_jit_query  GB_jit__bitmap_assign_5__000001c0eee0ee82__LG_MF_InitForw_query
#endif
#include "template/GB_jit_kernel_bitmap_assign_5.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0xccf2c5d201675269 ;
    v [0] = 10 ; v [1] = 4 ; v [2] = 0 ;
