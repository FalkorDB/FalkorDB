//------------------------------------------------------------------------------
// GB_jit__bitmap_assign_5_whole__001c101199909980.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__bitmap_assign_5_whole__001c101199909980
#define GB_jit_query  GB_jit__bitmap_assign_5_whole__001c101199909980_query
#endif
#include "template/GB_jit_kernel_bitmap_assign_5_whole.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x0794a0fbd2c46659 ;
    v [0] = 10 ; v [1] = 0 ; v [2] = 2 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
