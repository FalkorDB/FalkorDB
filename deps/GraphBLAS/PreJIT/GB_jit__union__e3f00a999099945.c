//------------------------------------------------------------------------------
// GB_jit__union__e3f00a999099945.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__union__e3f00a999099945
#define GB_jit_query  GB_jit__union__e3f00a999099945_query
#endif
#include "template/GB_jit_kernel_union.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x5fec2522d4f575b6 ;
    v [0] = 10 ; v [1] = 0 ; v [2] = 2 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
