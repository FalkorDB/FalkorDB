//------------------------------------------------------------------------------
// GB_jit__subassign_06s__7fe0407f00021100.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__subassign_06s__7fe0407f00021100
#define GB_jit_query  GB_jit__subassign_06s__7fe0407f00021100_query
#endif
#include "template/GB_jit_kernel_subassign_06s.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x1824834ccb6f69fb ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
