//------------------------------------------------------------------------------
// GB_jit__subassign_02__7f1c417f00001101.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__subassign_02__7f1c417f00001101
#define GB_jit_query  GB_jit__subassign_02__7f1c417f00001101_query
#endif
#include "template/GB_jit_kernel_subassign_02.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x16bfaf3b98f5e7d1 ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 0 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
