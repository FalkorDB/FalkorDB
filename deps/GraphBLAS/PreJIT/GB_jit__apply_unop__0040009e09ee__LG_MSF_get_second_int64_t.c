//------------------------------------------------------------------------------
// GB_jit__apply_unop__0040009e09ee__LG_MSF_get_second_int64_t.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__apply_unop__0040009e09ee__LG_MSF_get_second_int64_t
#define GB_jit_query  GB_jit__apply_unop__0040009e09ee__LG_MSF_get_second_int64_t_query
#endif
#include "template/GB_jit_kernel_apply_unop.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x87505da94666788c ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
