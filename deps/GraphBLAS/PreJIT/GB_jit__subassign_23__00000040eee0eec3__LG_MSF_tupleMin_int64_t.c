//------------------------------------------------------------------------------
// GB_jit__subassign_23__00000040eee0eec3__LG_MSF_tupleMin_int64_t.c
//------------------------------------------------------------------------------
...
// accum: LG_MSF_tupleMin_int64_t, ztype: LG_MSF_tuple_int64_t, xtype: LG_MSF_tuple_int64_t, ytype: LG_MSF_tuple_int64_t
...
#define GB_DECLAREZ(zwork) LG_MSF_tuple_int64_t zwork
#define GB_DECLAREX(xwork) LG_MSF_tuple_int64_t xwork
#define GB_DECLAREY(ywork) LG_MSF_tuple_int64_t ywork
...
"void LG_MSF_tupleMin_int64_t ( LG_MSF_tuple_int64_t *z, const LG_MSF_tuple_int64_t *x, const LG_MSF_tuple_int64_t *y ) { _Bool xSmaller = x->wInt < y->wInt || (x->wInt == y->wInt && x->idx < y->idx); z->wInt = (xSmaller)? x->wInt: y->wInt; z->idx = (xSmaller)? x->idx: y->idx; }"
#endif
#define GB_ACCUM_OP(z,x,y)  LG_MSF_tupleMin_int64_t (&(z), &(x), &(y))
...
#define GB_DECLAREC(cwork) LG_MSF_tuple_int64_t cwork
...
#define GB_jit_kernel GB_jit__subassign_23__00000040eee0eec3__LG_MSF_tupleMin_int64_t
#define GB_jit_query  GB_jit__subassign_23__00000040eee0eec3__LG_MSF_tupleMin_int64_t_query
#endif
#include "template/GB_jit_kernel_subassign_23.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0xa2daa385d095932f ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
