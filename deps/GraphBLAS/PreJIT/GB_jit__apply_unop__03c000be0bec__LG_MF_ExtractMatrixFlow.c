//------------------------------------------------------------------------------
// GB_jit__apply_unop__03c000be0bec__LG_MF_ExtractMatrixFlow.c
//------------------------------------------------------------------------------
...
// op: LG_MF_ExtractMatrixFlow, ztype: double, xtype: LG_MF_flowEdge, ytype: void
...
// unary operator:
#ifndef GB_GUARD_LG_MF_ExtractMatrixFlow_DEFINED
#define GB_GUARD_LG_MF_ExtractMatrixFlow_DEFINED
GB_STATIC_INLINE
void LG_MF_ExtractMatrixFlow(double* flow, const LG_MF_flowEdge* edge){ *flow = edge->flow; }
#define GB_LG_MF_ExtractMatrixFlow_USER_DEFN \
"void LG_MF_ExtractMatrixFlow(double* flow, const LG_MF_flowEdge* edge){ *flow = edge->flow; }"
#endif
#define GB_UNARYOP(z,x,i,j,y)  LG_MF_ExtractMatrixFlow (&(z), &(x))
...
#define GB_jit_kernel GB_jit__apply_unop__03c000be0bec__LG_MF_ExtractMatrixFlow
#define GB_jit_query  GB_jit__apply_unop__03c000be0bec__LG_MF_ExtractMatrixFlow_query
#endif
#include "template/GB_jit_kernel_apply_unop.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x9a8106c20747225a ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
    defn [0] = GB_LG_MF_ExtractMatrixFlow_USER_DEFN ;
    defn [1] = NULL ;
    defn [2] = NULL ;
