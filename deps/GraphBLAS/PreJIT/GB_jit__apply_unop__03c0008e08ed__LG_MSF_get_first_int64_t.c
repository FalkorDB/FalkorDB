//------------------------------------------------------------------------------
// GB_jit__apply_unop__03c0008e08ed__LG_MSF_get_first_int64_t.c
//------------------------------------------------------------------------------
...
// op: LG_MSF_get_first_int64_t, ztype: int64_t, xtype: LG_MSF_tuple_int64_t, ytype: void
...
// unary operator:
#ifndef GB_GUARD_LG_MSF_get_first_int64_t_DEFINED
#define GB_GUARD_LG_MSF_get_first_int64_t_DEFINED
GB_STATIC_INLINE
void LG_MSF_get_first_int64_t (int64_t *y, const LG_MSF_tuple_int64_t *x) { *y = x->wInt; }
#define GB_LG_MSF_get_first_int64_t_USER_DEFN \
"void LG_MSF_get_first_int64_t (int64_t *y, const LG_MSF_tuple_int64_t *x) { *y = x->wInt; }"
#endif
#define GB_UNARYOP(z,x,i,j,y)  LG_MSF_get_first_int64_t (&(z), &(x))
...
#define GB_jit_kernel GB_jit__apply_unop__03c0008e08ed__LG_MSF_get_first_int64_t
#define GB_jit_query  GB_jit__apply_unop__03c0008e08ed__LG_MSF_get_first_int64_t_query
#endif
#include "template/GB_jit_kernel_apply_unop.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0xae4f5bf15c6c903d ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
    defn [0] = GB_LG_MSF_get_first_int64_t_USER_DEFN ;
    defn [1] = NULL ;
    defn [2] = NULL ;
