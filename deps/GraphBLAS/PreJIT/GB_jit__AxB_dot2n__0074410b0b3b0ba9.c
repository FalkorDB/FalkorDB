//------------------------------------------------------------------------------
// GB_jit__AxB_dot2n__0074410b0b3b0ba9.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__AxB_dot2n__0074410b0b3b0ba9
#define GB_jit_query  GB_jit__AxB_dot2n__0074410b0b3b0ba9_query
#endif
#include "template/GB_jit_kernel_AxB_dot2n.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x5af905ae04a67906 ;
    v [0] = 10 ; v [1] = 0 ; v [2] = 2 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
