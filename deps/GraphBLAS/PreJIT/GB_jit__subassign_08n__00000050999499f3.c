//------------------------------------------------------------------------------
// GB_jit__subassign_08n__00000050999499f3.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__subassign_08n__00000050999499f3
#define GB_jit_query  GB_jit__subassign_08n__00000050999499f3_query
#endif
#include "template/GB_jit_kernel_subassign_08n.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x37a5bfa184ccb9d4 ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 0 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
