//------------------------------------------------------------------------------
// GB_jit__subassign_08s__08004043666366ee.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__subassign_08s__08004043666366ee
#define GB_jit_query  GB_jit__subassign_08s__08004043666366ee_query
#endif
#include "template/GB_jit_kernel_subassign_08s.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0xde0fc9eee1d22d56 ;
    v [0] = 10 ; v [1] = 4 ; v [2] = 0 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
