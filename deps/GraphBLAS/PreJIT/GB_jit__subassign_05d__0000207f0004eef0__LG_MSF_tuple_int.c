//------------------------------------------------------------------------------
// GB_jit__subassign_05d__0000207f0004eef0__LG_MSF_tuple_int.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__subassign_05d__0000207f0004eef0__LG_MSF_tuple_int
#define GB_jit_query  GB_jit__subassign_05d__0000207f0004eef0__LG_MSF_tuple_int_query
#endif
#include "template/GB_jit_kernel_subassign_05d.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0xe645639c8e5584ed ;
    v [0] = 10 ; v [1] = 0 ; v [2] = 2 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
