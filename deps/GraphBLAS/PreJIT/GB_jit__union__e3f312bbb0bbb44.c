//------------------------------------------------------------------------------
// GB_jit__union__e3f312bbb0bbb44.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__union__e3f312bbb0bbb44
#define GB_jit_query  GB_jit__union__e3f312bbb0bbb44_query
#endif
#include "template/GB_jit_kernel_union.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x55d3293cfa6f2821 ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
