//------------------------------------------------------------------------------
// GB_jit__subref_sparse__3f0490.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__subref_sparse__3f0490
#define GB_jit_query  GB_jit__subref_sparse__3f0490_query
#endif
#include "template/GB_jit_kernel_subref_sparse.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0xa4ea98021dff6bf4 ;
    v [0] = 10 ; v [1] = 0 ; v [2] = 2 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
