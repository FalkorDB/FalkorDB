//------------------------------------------------------------------------------
// GB_jit__masker_phase2__1c004e9e__LG_MSF_tuple_int.c
//------------------------------------------------------------------------------
...
#define GB_R_TYPE LG_MSF_tuple_int
...
#define GB_jit_kernel GB_jit__masker_phase2__1c004e9e__LG_MSF_tuple_int
#define GB_jit_query  GB_jit__masker_phase2__1c004e9e__LG_MSF_tuple_int_query
#endif
#include "template/GB_jit_kernel_masker_phase2.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x3b061acd39cb089c ;
    v [0] = 10 ; v [1] = 0 ; v [2] = 2 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
