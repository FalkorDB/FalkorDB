//------------------------------------------------------------------------------
// GB_jit__emult_08__fff000eeb2eeb55__LG_MF_UpdateFlow.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__emult_08__fff000eeb2eeb55__LG_MF_UpdateFlow
#define GB_jit_query  GB_jit__emult_08__fff000eeb2eeb55__LG_MF_UpdateFlow_query
#endif
#include "template/GB_jit_kernel_emult_08.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0xfcdb1338a16bf344 ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
