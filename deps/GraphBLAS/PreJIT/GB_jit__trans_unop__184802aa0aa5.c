//------------------------------------------------------------------------------
// GB_jit__trans_unop__184802aa0aa5.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__trans_unop__184802aa0aa5
#define GB_jit_query  GB_jit__trans_unop__184802aa0aa5_query
#endif
#include "template/GB_jit_kernel_trans_unop.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x0cfe692d3c4f6bc9 ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
