//------------------------------------------------------------------------------
// GB_jit__subassign_08s__08e04043666366df.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__subassign_08s__08e04043666366df
#define GB_jit_query  GB_jit__subassign_08s__08e04043666366df_query
#endif
#include "template/GB_jit_kernel_subassign_08s.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0xa59f13ac1515dff8 ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
