...
#define GB_ADD(z,x,y) z = fmax (x,y)
...
#define GB_jit_kernel GB_jit__reduce__13bb3
#define GB_jit_query  GB_jit__reduce__13bb3_query
#endif
#include "template/GB_jit_kernel_reduce.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x983feff8c8f262fd ;
    v [0] = 10 ; v [1] = 4 ; v [2] = 0 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
