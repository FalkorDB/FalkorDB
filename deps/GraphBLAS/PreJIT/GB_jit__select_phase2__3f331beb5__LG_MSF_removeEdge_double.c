//------------------------------------------------------------------------------
// GB_jit__select_phase2__3f331beb5__LG_MSF_removeEdge_double.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__select_phase2__3f331beb5__LG_MSF_removeEdge_double
#define GB_jit_query  GB_jit__select_phase2__3f331beb5__LG_MSF_removeEdge_double_query
#endif
#include "template/GB_jit_kernel_select_phase2.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0xe085ead40bf54ffd ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
