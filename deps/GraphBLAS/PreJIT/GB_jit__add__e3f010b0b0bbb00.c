//------------------------------------------------------------------------------
// GB_jit__add__e3f010b0b0bbb00.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__add__e3f010b0b0bbb00
#define GB_jit_query  GB_jit__add__e3f010b0b0bbb00_query
#endif
#include "template/GB_jit_kernel_add.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0xa2826d7923319e93 ;
    v [0] = 10 ; v [1] = 0 ; v [2] = 2 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
