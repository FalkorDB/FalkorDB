//------------------------------------------------------------------------------
// GB_jit__rowscale__010200e1e0e1ec7__LG_MSF_tuple2nd_int64_t.c
//------------------------------------------------------------------------------
...
// op: LG_MSF_tuple2nd_int64_t, ztype: LG_MSF_tuple_int64_t, xtype: bool, ytype: LG_MSF_tuple_int64_t
...
"void LG_MSF_tuple2nd_int64_t ( LG_MSF_tuple_int64_t *z, const void *x, const LG_MSF_tuple_int64_t *y ) { z->wInt = y->wInt; z->idx = y->idx; }"
#endif
#define GB_BINOP(z,x,y,i,j)  LG_MSF_tuple2nd_int64_t (&(z), &(x), &(y))
...
#define GB_jit_kernel GB_jit__rowscale__010200e1e0e1ec7__LG_MSF_tuple2nd_int64_t
#define GB_jit_query  GB_jit__rowscale__010200e1e0e1ec7__LG_MSF_tuple2nd_int64_t_query
#endif
#include "template/GB_jit_kernel_rowscale.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x05d4d3c7da13a79c ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
    defn [0] = GB_LG_MSF_tuple2nd_int64_t_USER_DEFN ;
    defn [1] = NULL ;
