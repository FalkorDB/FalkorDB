//------------------------------------------------------------------------------
// GB_jit__apply_unop__03c000be0bed__LG_MSF_get_first_fp.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__apply_unop__03c000be0bed__LG_MSF_get_first_fp
#define GB_jit_query  GB_jit__apply_unop__03c000be0bed__LG_MSF_get_first_fp_query
#endif
#include "template/GB_jit_kernel_apply_unop.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x65ac6b740662fa95 ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 0 ;
