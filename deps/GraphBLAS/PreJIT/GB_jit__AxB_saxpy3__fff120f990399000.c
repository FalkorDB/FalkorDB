//------------------------------------------------------------------------------
// GB_jit__AxB_saxpy3__fff120f990399000.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__AxB_saxpy3__fff120f990399000
#define GB_jit_query  GB_jit__AxB_saxpy3__fff120f990399000_query
#endif
#include "template/GB_jit_kernel_AxB_saxpy3.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x8181059be3e89a97 ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
