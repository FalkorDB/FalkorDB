//------------------------------------------------------------------------------
// GB_jit__AxB_dot4__0380c00e890e89c7__LG_MSF_tupleMin_int_LG_MSF_combine_int.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__AxB_dot4__0380c00e890e89c7__LG_MSF_tupleMin_int_LG_MSF_combine_int
#define GB_jit_query  GB_jit__AxB_dot4__0380c00e890e89c7__LG_MSF_tupleMin_int_LG_MSF_combine_int_query
#endif
#include "template/GB_jit_kernel_AxB_dot4.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x8040d8bfe8cf1adc ;
    v [0] = 10 ; v [1] = 0 ; v [2] = 2 ;
