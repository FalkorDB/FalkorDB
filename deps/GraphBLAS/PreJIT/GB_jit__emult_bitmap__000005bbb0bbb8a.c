//------------------------------------------------------------------------------
// GB_jit__emult_bitmap__000005bbb0bbb8a.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__emult_bitmap__000005bbb0bbb8a
#define GB_jit_query  GB_jit__emult_bitmap__000005bbb0bbb8a_query
#endif
#include "template/GB_jit_kernel_emult_bitmap.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x719d8bc774b671c0 ;
    v [0] = 10 ; v [1] = 0 ; v [2] = 2 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
