//------------------------------------------------------------------------------
// GB_jit__AxB_saxbit__000420fbb00bb08b.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__AxB_saxbit__000420fbb00bb08b
#define GB_jit_query  GB_jit__AxB_saxbit__000420fbb00bb08b_query
#endif
#include "template/GB_jit_kernel_AxB_saxbit.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x5d29af74ed3c964b ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
