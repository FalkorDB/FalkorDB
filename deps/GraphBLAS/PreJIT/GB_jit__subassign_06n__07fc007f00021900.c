//------------------------------------------------------------------------------
// GB_jit__subassign_06n__07fc007f00021900.c
//------------------------------------------------------------------------------
...
#define GB_COPY_A_to_C(Cx,pC,Ax,pA,A_iso) Cx [pC] = ((Ax [pA]) != 0)
#define GB_COPY_aij_to_C(Cx,pC,Ax,pA,A_iso,cwork,C_iso) \
    GB_COPY_A_to_C (Cx, pC, Ax, pA, A_iso)
#define GB_COPY_aij_to_cwork(cwork,Ax,p,A_iso) cwork = ((Ax [p]) != 0)
...
#define GB_jit_kernel GB_jit__subassign_06n__07fc007f00021900
#define GB_jit_query  GB_jit__subassign_06n__07fc007f00021900_query
#endif
#include "template/GB_jit_kernel_subassign_06n.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x2ca7f10df313c018 ;
    v [0] = 10 ; v [1] = 0 ; v [2] = 2 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
