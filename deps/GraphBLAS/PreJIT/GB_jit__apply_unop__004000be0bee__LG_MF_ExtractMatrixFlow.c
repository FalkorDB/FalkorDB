//------------------------------------------------------------------------------
// GB_jit__apply_unop__004000be0bee__LG_MF_ExtractMatrixFlow.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__apply_unop__004000be0bee__LG_MF_ExtractMatrixFlow
#define GB_jit_query  GB_jit__apply_unop__004000be0bee__LG_MF_ExtractMatrixFlow_query
#endif
#include "template/GB_jit_kernel_apply_unop.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0xc9b7a261a4c9fbd7 ;
    v [0] = 10 ; v [1] = 4 ; v [2] = 0 ;
