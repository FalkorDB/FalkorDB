...
#define GB_Tx_TYPE uint8_t
#define GB_Sx_TYPE uint8_t
...
#define GB_jit_kernel GB_jit__build__1fe9033333
#define GB_jit_query  GB_jit__build__1fe9033333_query
#endif
#include "template/GB_jit_kernel_build.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0xc675cb8a159cde64 ;
    v [0] = 10 ; v [1] = 4 ; v [2] = 0 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
