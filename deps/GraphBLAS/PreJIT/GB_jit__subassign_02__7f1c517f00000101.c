//------------------------------------------------------------------------------
// GB_jit__subassign_02__7f1c517f00000101.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__subassign_02__7f1c517f00000101
#define GB_jit_query  GB_jit__subassign_02__7f1c517f00000101_query
#endif
#include "template/GB_jit_kernel_subassign_02.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0xfe310ed975d9b9d1 ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 0 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
