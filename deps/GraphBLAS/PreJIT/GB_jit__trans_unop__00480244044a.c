//------------------------------------------------------------------------------
// GB_jit__trans_unop__00480244044a.c
//------------------------------------------------------------------------------
...
#define GB_DECLAREZ(zwork) int16_t zwork
#define GB_DECLAREX(xwork) int16_t xwork
...
#define GB_DECLAREA(a) int16_t a
...
#define GB_jit_kernel GB_jit__trans_unop__00480244044a
#define GB_jit_query  GB_jit__trans_unop__00480244044a_query
#endif
#include "template/GB_jit_kernel_trans_unop.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0xa3c697301f7fdd46 ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
