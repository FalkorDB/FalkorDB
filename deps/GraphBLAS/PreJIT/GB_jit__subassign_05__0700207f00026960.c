//------------------------------------------------------------------------------
// GB_jit__subassign_05__0700207f00026960.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__subassign_05__0700207f00026960
#define GB_jit_query  GB_jit__subassign_05__0700207f00026960_query
#endif
#include "template/GB_jit_kernel_subassign_05.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x58d83a46736e1474 ;
    v [0] = 10 ; v [1] = 4 ; v [2] = 0 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
