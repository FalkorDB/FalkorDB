//------------------------------------------------------------------------------
// GB_jit__subassign_02__7f02447f0000bb46.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__subassign_02__7f02447f0000bb46
#define GB_jit_query  GB_jit__subassign_02__7f02447f0000bb46_query
#endif
#include "template/GB_jit_kernel_subassign_02.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x0d5bc6d2d1776fee ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
