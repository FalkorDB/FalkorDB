//------------------------------------------------------------------------------
// GB_jit__subassign_13__7fe0607f00050154.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__subassign_13__7fe0607f00050154
#define GB_jit_query  GB_jit__subassign_13__7fe0607f00050154_query
#endif
#include "template/GB_jit_kernel_subassign_13.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x637056a132599e68 ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 0 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
