//------------------------------------------------------------------------------
// GB_jit__apply_unop__004000eb0e8e__LG_MF_ResidualForward.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__apply_unop__004000eb0e8e__LG_MF_ResidualForward
#define GB_jit_query  GB_jit__apply_unop__004000eb0e8e__LG_MF_ResidualForward_query
#endif
#include "template/GB_jit_kernel_apply_unop.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x753f6b1489371c8e ;
    v [0] = 10 ; v [1] = 4 ; v [2] = 0 ;
