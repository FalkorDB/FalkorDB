//------------------------------------------------------------------------------
// GB_jit__apply_unop__03c000eb0ebc__LG_MF_ResidualBackward.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__apply_unop__03c000eb0ebc__LG_MF_ResidualBackward
#define GB_jit_query  GB_jit__apply_unop__03c000eb0ebc__LG_MF_ResidualBackward_query
#endif
#include "template/GB_jit_kernel_apply_unop.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x2ce9f9bb81b33ba9 ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
