//------------------------------------------------------------------------------
// GB_jit__select_phase2__3ff31beb5__LG_MSF_removeEdge_fp.c
//------------------------------------------------------------------------------
...
// op: LG_MSF_removeEdge_fp (flipped ij), ztype: bool, xtype: double, ytype: LG_MSF_context_fp
...
#ifndef GB_GUARD_LG_MSF_removeEdge_fp_DEFINED
#define GB_GUARD_LG_MSF_removeEdge_fp_DEFINED
GB_STATIC_INLINE
...
#define GB_LG_MSF_removeEdge_fp_USER_DEFN \
"void LG_MSF_removeEdge_fp                         \n" \
"(                                                 \n" \
"    bool *z,                                      \n" \
"    const double *x,                              \n" \
...
"}"
#endif
#define GB_IDXUNOP(z,x,j,i,y) LG_MSF_removeEdge_fp (&(z), &(x), i, j, &(y))
...
#define GB_jit_kernel GB_jit__select_phase2__3ff31beb5__LG_MSF_removeEdge_fp
#define GB_jit_query  GB_jit__select_phase2__3ff31beb5__LG_MSF_removeEdge_fp_query
#endif
#include "template/GB_jit_kernel_select_phase2.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x4d0915fa03553162 ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 0 ;
