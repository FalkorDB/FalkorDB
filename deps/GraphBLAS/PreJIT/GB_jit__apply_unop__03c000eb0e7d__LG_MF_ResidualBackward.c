//------------------------------------------------------------------------------
// GB_jit__apply_unop__03c000eb0e7d__LG_MF_ResidualBackward.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__apply_unop__03c000eb0e7d__LG_MF_ResidualBackward
#define GB_jit_query  GB_jit__apply_unop__03c000eb0e7d__LG_MF_ResidualBackward_query
#endif
#include "template/GB_jit_kernel_apply_unop.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x2e1f6c57d1ef85b1 ;
    v [0] = 10 ; v [1] = 4 ; v [2] = 0 ;
