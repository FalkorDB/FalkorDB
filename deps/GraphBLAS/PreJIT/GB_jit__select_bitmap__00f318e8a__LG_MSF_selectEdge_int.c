//------------------------------------------------------------------------------
// GB_jit__select_bitmap__00f318e8a__LG_MSF_selectEdge_int.c
//------------------------------------------------------------------------------
...
// op: LG_MSF_selectEdge_int (flipped ij), ztype: bool, xtype: int64_t, ytype: LG_MSF_context_int
...
#ifndef GB_GUARD_LG_MSF_selectEdge_int_DEFINED
#define GB_GUARD_LG_MSF_selectEdge_int_DEFINED
GB_STATIC_INLINE
...
#define GB_LG_MSF_selectEdge_int_USER_DEFN \
"void LG_MSF_selectEdge_int                            \n" \
"(                                                     \n" \
"    bool *z,                                          \n" \
"    const int64_t *x,                                 \n" \
...
"}"
#endif
#define GB_IDXUNOP(z,x,j,i,y) LG_MSF_selectEdge_int (&(z), &(x), i, j, &(y))
...
#define GB_jit_kernel GB_jit__select_bitmap__00f318e8a__LG_MSF_selectEdge_int
#define GB_jit_query  GB_jit__select_bitmap__00f318e8a__LG_MSF_selectEdge_int_query
#endif
#include "template/GB_jit_kernel_select_bitmap.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x17a3c352155c53a5 ;
    v [0] = 10 ; v [1] = 0 ; v [2] = 2 ;
    defn [0] = GB_LG_MSF_selectEdge_int_USER_DEFN ;
    defn [1] = NULL ;
    defn [2] = NULL ;
    defn [3] = NULL ;
    defn [4] = NULL ;
