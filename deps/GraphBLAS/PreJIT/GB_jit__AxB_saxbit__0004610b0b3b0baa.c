//------------------------------------------------------------------------------
// GB_jit__AxB_saxbit__0004610b0b3b0baa.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__AxB_saxbit__0004610b0b3b0baa
#define GB_jit_query  GB_jit__AxB_saxbit__0004610b0b3b0baa_query
#endif
#include "template/GB_jit_kernel_AxB_saxbit.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x7886a96a5d9265c4 ;
    v [0] = 10 ; v [1] = 0 ; v [2] = 2 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
