//------------------------------------------------------------------------------
// GB_jit__subassign_06s__7ffc407f0002bb54.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__subassign_06s__7ffc407f0002bb54
#define GB_jit_query  GB_jit__subassign_06s__7ffc407f0002bb54_query
#endif
#include "template/GB_jit_kernel_subassign_06s.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x15f11fd6ceb71841 ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
