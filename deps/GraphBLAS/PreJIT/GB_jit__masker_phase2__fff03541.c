//------------------------------------------------------------------------------
// GB_jit__masker_phase2__fff03541.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__masker_phase2__fff03541
#define GB_jit_query  GB_jit__masker_phase2__fff03541_query
#endif
#include "template/GB_jit_kernel_masker_phase2.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0xc3f833058b53314a ;
    v [0] = 10 ; v [1] = 0 ; v [2] = 2 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
