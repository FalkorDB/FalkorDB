//------------------------------------------------------------------------------
// GB_jit__subassign_15__08e06043666369dc.c
//------------------------------------------------------------------------------
...
// subassign: C<!M,struct> max= scalar 
...
#define GB_jit_kernel GB_jit__subassign_15__08e06043666369dc
#define GB_jit_query  GB_jit__subassign_15__08e06043666369dc_query
#endif
#include "template/GB_jit_kernel_subassign_15.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x3fa49c31c61e57d5 ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
