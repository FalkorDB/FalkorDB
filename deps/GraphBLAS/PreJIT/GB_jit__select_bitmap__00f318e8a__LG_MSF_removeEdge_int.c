//------------------------------------------------------------------------------
// GB_jit__select_bitmap__00f318e8a__LG_MSF_removeEdge_int.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__select_bitmap__00f318e8a__LG_MSF_removeEdge_int
#define GB_jit_query  GB_jit__select_bitmap__00f318e8a__LG_MSF_removeEdge_int_query
#endif
#include "template/GB_jit_kernel_select_bitmap.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0xc7079e086c351402 ;
    v [0] = 10 ; v [1] = 0 ; v [2] = 2 ;
