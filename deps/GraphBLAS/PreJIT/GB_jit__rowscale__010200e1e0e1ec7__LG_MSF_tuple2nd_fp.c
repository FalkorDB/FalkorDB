//------------------------------------------------------------------------------
// GB_jit__rowscale__010200e1e0e1ec7__LG_MSF_tuple2nd_fp.c
//------------------------------------------------------------------------------
...
// op: LG_MSF_tuple2nd_fp, ztype: LG_MSF_tuple_fp, xtype: bool, ytype: LG_MSF_tuple_fp
...
"}"
#endif
#define GB_BINOP(z,x,y,i,j)  LG_MSF_tuple2nd_fp (&(z), &(x), &(y))
...
#define GB_jit_kernel GB_jit__rowscale__010200e1e0e1ec7__LG_MSF_tuple2nd_fp
#define GB_jit_query  GB_jit__rowscale__010200e1e0e1ec7__LG_MSF_tuple2nd_fp_query
#endif
#include "template/GB_jit_kernel_rowscale.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x1f364439c6d17bb4 ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 0 ;
    defn [0] = GB_LG_MSF_tuple2nd_fp_USER_DEFN ;
    defn [1] = NULL ;
