//------------------------------------------------------------------------------
// GB_jit__select_bitmap__00f31beba__LG_MSF_selectEdge_fp.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__select_bitmap__00f31beba__LG_MSF_selectEdge_fp
#define GB_jit_query  GB_jit__select_bitmap__00f31beba__LG_MSF_selectEdge_fp_query
#endif
#include "template/GB_jit_kernel_select_bitmap.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x59daad9608aaf667 ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 0 ;
