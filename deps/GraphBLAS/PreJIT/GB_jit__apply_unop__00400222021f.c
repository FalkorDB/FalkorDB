//------------------------------------------------------------------------------
// GB_jit__apply_unop__00400222021f.c
//------------------------------------------------------------------------------
...
#define GB_DECLAREZ(zwork) int8_t zwork
#define GB_DECLAREX(xwork) int8_t xwork
...
#define GB_GETA(a,Ax,p,iso) a = (int8_t) (Ax [p])
...
#define GB_jit_kernel GB_jit__apply_unop__00400222021f
#define GB_jit_query  GB_jit__apply_unop__00400222021f_query
#endif
#include "template/GB_jit_kernel_apply_unop.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x0f9d403ad879f6c3 ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
