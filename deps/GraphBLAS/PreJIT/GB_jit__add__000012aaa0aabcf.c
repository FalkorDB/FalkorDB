//------------------------------------------------------------------------------
// GB_jit__add__000012aaa0aabcf.c
//------------------------------------------------------------------------------
...
#define GB_COPY_B_to_C(Cx,pC,Bx,pB,B_iso) Cx [pC] = (float) Bx [pB]
...
#define GB_GETB(b,Bx,p,iso) b = (float) (Bx [p])
...
#define GB_jit_kernel GB_jit__add__000012aaa0aabcf
#define GB_jit_query  GB_jit__add__000012aaa0aabcf_query
#endif
#include "template/GB_jit_kernel_add.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0xe47f51a5963b1e61 ;
    v [0] = 10 ; v [1] = 4 ; v [2] = 0 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
