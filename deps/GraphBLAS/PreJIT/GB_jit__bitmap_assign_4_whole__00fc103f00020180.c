//------------------------------------------------------------------------------
// GB_jit__bitmap_assign_4_whole__00fc103f00020180.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__bitmap_assign_4_whole__00fc103f00020180
#define GB_jit_query  GB_jit__bitmap_assign_4_whole__00fc103f00020180_query
#endif
#include "template/GB_jit_kernel_bitmap_assign_4_whole.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0xad715613bd563dd0 ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 0 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
