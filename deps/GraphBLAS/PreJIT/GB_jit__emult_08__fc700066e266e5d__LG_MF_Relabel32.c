//------------------------------------------------------------------------------
// GB_jit__emult_08__fc700066e266e5d__LG_MF_Relabel32.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__emult_08__fc700066e266e5d__LG_MF_Relabel32
#define GB_jit_query  GB_jit__emult_08__fc700066e266e5d__LG_MF_Relabel32_query
#endif
#include "template/GB_jit_kernel_emult_08.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x3b8a0e7c69fd9679 ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
