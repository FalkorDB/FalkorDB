//------------------------------------------------------------------------------
// GB_jit__apply_unop__03c0009e09ed__LG_MSF_get_second_double.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__apply_unop__03c0009e09ed__LG_MSF_get_second_double
#define GB_jit_query  GB_jit__apply_unop__03c0009e09ed__LG_MSF_get_second_double_query
#endif
#include "template/GB_jit_kernel_apply_unop.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x2ee1fbc753642dcd ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
