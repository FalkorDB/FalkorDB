//------------------------------------------------------------------------------
// GB_jit__select_phase1__3ff318e85__LG_MSF_selectEdge_int64_t.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__select_phase1__3ff318e85__LG_MSF_selectEdge_int64_t
#define GB_jit_query  GB_jit__select_phase1__3ff318e85__LG_MSF_selectEdge_int64_t_query
#endif
#include "template/GB_jit_kernel_select_phase1.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0xf0e91c838cd00bd0 ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
