//------------------------------------------------------------------------------
// GB_jit__rowscale__010200e1e0e1ec7__LG_MSF_tuple2nd_int.c
//------------------------------------------------------------------------------
...
// op: LG_MSF_tuple2nd_int, ztype: LG_MSF_tuple_int, xtype: bool, ytype: LG_MSF_tuple_int
...
"}"
#endif
#define GB_BINOP(z,x,y,i,j)  LG_MSF_tuple2nd_int (&(z), &(x), &(y))
...
#define GB_jit_kernel GB_jit__rowscale__010200e1e0e1ec7__LG_MSF_tuple2nd_int
#define GB_jit_query  GB_jit__rowscale__010200e1e0e1ec7__LG_MSF_tuple2nd_int_query
#endif
#include "template/GB_jit_kernel_rowscale.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x73b03387d2aa6433 ;
    v [0] = 10 ; v [1] = 0 ; v [2] = 2 ;
    defn [0] = GB_LG_MSF_tuple2nd_int_USER_DEFN ;
    defn [1] = NULL ;
