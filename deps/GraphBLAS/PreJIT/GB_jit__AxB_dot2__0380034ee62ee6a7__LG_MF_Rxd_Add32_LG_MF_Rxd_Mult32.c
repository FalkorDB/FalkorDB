//------------------------------------------------------------------------------
// GB_jit__AxB_dot2__0380034ee62ee6a7__LG_MF_Rxd_Add32_LG_MF_Rxd_Mult32.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__AxB_dot2__0380034ee62ee6a7__LG_MF_Rxd_Add32_LG_MF_Rxd_Mult32
#define GB_jit_query  GB_jit__AxB_dot2__0380034ee62ee6a7__LG_MF_Rxd_Add32_LG_MF_Rxd_Mult32_query
#endif
#include "template/GB_jit_kernel_AxB_dot2.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x76b0fb191eba2964 ;
    v [0] = 10 ; v [1] = 4 ; v [2] = 0 ;
