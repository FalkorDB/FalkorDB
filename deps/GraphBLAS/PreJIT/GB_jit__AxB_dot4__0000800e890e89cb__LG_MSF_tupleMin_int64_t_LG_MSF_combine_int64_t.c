//------------------------------------------------------------------------------
// GB_jit__AxB_dot4__0000800e890e89cb__LG_MSF_tupleMin_int64_t_LG_MSF_combine_int64_t.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__AxB_dot4__0000800e890e89cb__LG_MSF_tupleMin_int64_t_LG_MSF_combine_int64_t
#define GB_jit_query  GB_jit__AxB_dot4__0000800e890e89cb__LG_MSF_tupleMin_int64_t_LG_MSF_combine_int64_t_query
#endif
#include "template/GB_jit_kernel_AxB_dot4.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x4b085a4aa05882a1 ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
