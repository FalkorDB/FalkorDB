//------------------------------------------------------------------------------
// GB_jit__select_phase1__3f3319190__locate_tensors.c
//------------------------------------------------------------------------------
...
// op: locate_tensors (flipped ij), ztype: bool, xtype: uint64_t, ytype: bool
...
#ifndef GB_GUARD_locate_tensors_DEFINED
#define GB_GUARD_locate_tensors_DEFINED
GB_STATIC_INLINE
void locate_tensors ( _Bool *z, const uint64_t *x, GrB_Index i, GrB_Index j, const void *y ) { *z = !!((*x) & (1UL << (sizeof(uint64_t) * 8 - 1))) ; }
#define GB_locate_tensors_USER_DEFN \
"void locate_tensors ( _Bool *z, const uint64_t *x, GrB_Index i, GrB_Index j, const void *y ) { *z = !!((*x) & (1UL << (sizeof(uint64_t) * 8 - 1))) ; }"
#endif
#define GB_IDXUNOP(z,x,j,i,y) locate_tensors (&(z), &(x), i, j, &(y))
...
#define GB_jit_kernel GB_jit__select_phase1__3f3319190__locate_tensors
#define GB_jit_query  GB_jit__select_phase1__3f3319190__locate_tensors_query
#endif
#include "template/GB_jit_kernel_select_phase1.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x887d0f42064b363c ;
    v [0] = 10 ; v [1] = 4 ; v [2] = 0 ;
    defn [0] = GB_locate_tensors_USER_DEFN ;
    defn [1] = NULL ;
    defn [2] = NULL ;
    defn [3] = NULL ;
    defn [4] = NULL ;
