//------------------------------------------------------------------------------
// GB_jit__emult_02__e38002bbb0bbb47.c
//------------------------------------------------------------------------------
...
// binary operator:
#define GB_BINOP(z,x,y,i,j) z = fmin (x,y)
...
#define GB_jit_kernel GB_jit__emult_02__e38002bbb0bbb47
#define GB_jit_query  GB_jit__emult_02__e38002bbb0bbb47_query
#endif
#include "template/GB_jit_kernel_emult_02.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x06cf7ce903a27b0e ;
    v [0] = 10 ; v [1] = 4 ; v [2] = 0 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
