//------------------------------------------------------------------------------
// GB_jit__apply_bind2nd__000014bbb0bbfcc.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__apply_bind2nd__000014bbb0bbfcc
#define GB_jit_query  GB_jit__apply_bind2nd__000014bbb0bbfcc_query
#endif
#include "template/GB_jit_kernel_apply_bind2nd.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x4f51821123a5ca49 ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
