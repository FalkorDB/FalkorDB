//------------------------------------------------------------------------------
// GB_jit__subassign_06n__07fc007f0002ee40__LG_MF_flowEdge.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__subassign_06n__07fc007f0002ee40__LG_MF_flowEdge
#define GB_jit_query  GB_jit__subassign_06n__07fc007f0002ee40__LG_MF_flowEdge_query
#endif
#include "template/GB_jit_kernel_subassign_06n.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x18174eff67174293 ;
    v [0] = 10 ; v [1] = 4 ; v [2] = 0 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
