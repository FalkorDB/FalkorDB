//------------------------------------------------------------------------------
// GB_jit__emult_02__e380231bb01bb46.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__emult_02__e380231bb01bb46
#define GB_jit_query  GB_jit__emult_02__e380231bb01bb46_query
#endif
#include "template/GB_jit_kernel_emult_02.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0xe80a1b8cd716da61 ;
    v [0] = 10 ; v [1] = 0 ; v [2] = 2 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
