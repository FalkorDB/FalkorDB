//------------------------------------------------------------------------------
// GB_jit__bitmap_assign_5__001c11c0eee0ee81__LG_MF_InitForw.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__bitmap_assign_5__001c11c0eee0ee81__LG_MF_InitForw
#define GB_jit_query  GB_jit__bitmap_assign_5__001c11c0eee0ee81__LG_MF_InitForw_query
#endif
#include "template/GB_jit_kernel_bitmap_assign_5.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x3c12285bcae4aec2 ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
