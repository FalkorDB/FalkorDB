//------------------------------------------------------------------------------
// GB_jit__emult_bitmap__000005bbb0bbb8b.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__emult_bitmap__000005bbb0bbb8b
#define GB_jit_query  GB_jit__emult_bitmap__000005bbb0bbb8b_query
#endif
#include "template/GB_jit_kernel_emult_bitmap.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x3f5240e8594e8200 ;
    v [0] = 10 ; v [1] = 4 ; v [2] = 0 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
