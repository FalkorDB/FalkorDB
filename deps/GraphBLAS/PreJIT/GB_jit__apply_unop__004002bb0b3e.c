//------------------------------------------------------------------------------
// GB_jit__apply_unop__004002bb0b3e.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__apply_unop__004002bb0b3e
#define GB_jit_query  GB_jit__apply_unop__004002bb0b3e_query
#endif
#include "template/GB_jit_kernel_apply_unop.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x72d1c9fa8279c6fd ;
    v [0] = 10 ; v [1] = 0 ; v [2] = 2 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
