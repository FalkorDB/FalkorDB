//------------------------------------------------------------------------------
// GB_jit__add__000203aaa0aaacf.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__add__000203aaa0aaacf
#define GB_jit_query  GB_jit__add__000203aaa0aaacf_query
#endif
#include "template/GB_jit_kernel_add.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0xc5c99df762583c2a ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 0 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
