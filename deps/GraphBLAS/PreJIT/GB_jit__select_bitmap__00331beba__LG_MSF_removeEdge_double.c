//------------------------------------------------------------------------------
// GB_jit__select_bitmap__00331beba__LG_MSF_removeEdge_double.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__select_bitmap__00331beba__LG_MSF_removeEdge_double
#define GB_jit_query  GB_jit__select_bitmap__00331beba__LG_MSF_removeEdge_double_query
#endif
#include "template/GB_jit_kernel_select_bitmap.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x74576c2c9f20617c ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
