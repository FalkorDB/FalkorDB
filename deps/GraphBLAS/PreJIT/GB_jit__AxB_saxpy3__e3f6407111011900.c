//------------------------------------------------------------------------------
// GB_jit__AxB_saxpy3__e3f6407111011900.c
//------------------------------------------------------------------------------
...
#define GB_MULT(z,x,y,i,k,j) z = ((x) && (y))

// multiply-add operator:
#define GB_MULTADD(z,x,y,i,k,j) z |= ((x) && (y))
...
#define GB_jit_kernel GB_jit__AxB_saxpy3__e3f6407111011900
#define GB_jit_query  GB_jit__AxB_saxpy3__e3f6407111011900_query
#endif
#include "template/GB_jit_kernel_AxB_saxpy3.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x3546b294f247b1bc ;
    v [0] = 10 ; v [1] = 0 ; v [2] = 2 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
