//------------------------------------------------------------------------------
// GB_jit__subassign_04__7f1c405199909900.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__subassign_04__7f1c405199909900
#define GB_jit_query  GB_jit__subassign_04__7f1c405199909900_query
#endif
#include "template/GB_jit_kernel_subassign_04.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x820c19e14c9512f3 ;
    v [0] = 10 ; v [1] = 0 ; v [2] = 2 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
