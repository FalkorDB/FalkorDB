//------------------------------------------------------------------------------
// GB_jit__select_phase2__3f131e1e5__LG_MF_Prune32.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__select_phase2__3f131e1e5__LG_MF_Prune32
#define GB_jit_query  GB_jit__select_phase2__3f131e1e5__LG_MF_Prune32_query
#endif
#include "template/GB_jit_kernel_select_phase2.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0xf00610c5a2c9e1b3 ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
