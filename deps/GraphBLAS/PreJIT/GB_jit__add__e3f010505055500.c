//------------------------------------------------------------------------------
// GB_jit__add__e3f010505055500.c
//------------------------------------------------------------------------------
...
#define GB_DECLAREB(b) uint16_t b
...
#define GB_jit_kernel GB_jit__add__e3f010505055500
#define GB_jit_query  GB_jit__add__e3f010505055500_query
#endif
#include "template/GB_jit_kernel_add.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x74c0fdf0a0ba8a1a ;
    v [0] = 10 ; v [1] = 4 ; v [2] = 0 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
