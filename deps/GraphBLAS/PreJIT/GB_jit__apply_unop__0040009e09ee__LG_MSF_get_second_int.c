//------------------------------------------------------------------------------
// GB_jit__apply_unop__0040009e09ee__LG_MSF_get_second_int.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__apply_unop__0040009e09ee__LG_MSF_get_second_int
#define GB_jit_query  GB_jit__apply_unop__0040009e09ee__LG_MSF_get_second_int_query
#endif
#include "template/GB_jit_kernel_apply_unop.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0xf5ae096e8d3317ef ;
    v [0] = 10 ; v [1] = 0 ; v [2] = 2 ;
