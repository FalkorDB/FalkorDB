//------------------------------------------------------------------------------
// GB_jit__subref_sparse__3f00b5.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__subref_sparse__3f00b5
#define GB_jit_query  GB_jit__subref_sparse__3f00b5_query
#endif
#include "template/GB_jit_kernel_subref_sparse.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0xb254e63ef0644e0d ;
    v [0] = 10 ; v [1] = 0 ; v [2] = 2 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
