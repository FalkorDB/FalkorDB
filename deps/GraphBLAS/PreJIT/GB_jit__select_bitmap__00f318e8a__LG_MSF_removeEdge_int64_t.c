//------------------------------------------------------------------------------
// GB_jit__select_bitmap__00f318e8a__LG_MSF_removeEdge_int64_t.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__select_bitmap__00f318e8a__LG_MSF_removeEdge_int64_t
#define GB_jit_query  GB_jit__select_bitmap__00f318e8a__LG_MSF_removeEdge_int64_t_query
#endif
#include "template/GB_jit_kernel_select_bitmap.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x15e8fe8470514742 ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
