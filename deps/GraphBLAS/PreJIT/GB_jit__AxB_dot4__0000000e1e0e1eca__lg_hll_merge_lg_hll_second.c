//------------------------------------------------------------------------------
// GB_jit__AxB_dot4__0000000e1e0e1eca__lg_hll_merge_lg_hll_second.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__AxB_dot4__0000000e1e0e1eca__lg_hll_merge_lg_hll_second
#define GB_jit_query  GB_jit__AxB_dot4__0000000e1e0e1eca__lg_hll_merge_lg_hll_second_query
#endif
#include "template/GB_jit_kernel_AxB_dot4.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x98881923cee46324 ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
