//------------------------------------------------------------------------------
// GB_jit__add__e3f301111019100.c
//------------------------------------------------------------------------------
...
#define GB_COPY_A_to_C(Cx,pC,Ax,pA,A_iso) Cx [pC] = ((Ax [0]) != 0)
#define GB_COPY_B_to_C(Cx,pC,Bx,pB,B_iso) Cx [pC] = Bx [0]
...
#define GB_GETA(a,Ax,p,iso) a = ((Ax [0]) != 0)
...
#define GB_jit_kernel GB_jit__add__e3f301111019100
#define GB_jit_query  GB_jit__add__e3f301111019100_query
#endif
#include "template/GB_jit_kernel_add.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0xff3ada93fdff371a ;
    v [0] = 10 ; v [1] = 4 ; v [2] = 0 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
