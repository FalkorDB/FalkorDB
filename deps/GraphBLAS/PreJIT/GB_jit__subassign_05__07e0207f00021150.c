//------------------------------------------------------------------------------
// GB_jit__subassign_05__07e0207f00021150.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__subassign_05__07e0207f00021150
#define GB_jit_query  GB_jit__subassign_05__07e0207f00021150_query
#endif
#include "template/GB_jit_kernel_subassign_05.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x8e5276b2d44be433 ;
    v [0] = 10 ; v [1] = 0 ; v [2] = 2 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
