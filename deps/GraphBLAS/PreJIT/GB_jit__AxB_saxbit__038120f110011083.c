//------------------------------------------------------------------------------
// GB_jit__AxB_saxbit__038120f110011083.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__AxB_saxbit__038120f110011083
#define GB_jit_query  GB_jit__AxB_saxbit__038120f110011083_query
#endif
#include "template/GB_jit_kernel_AxB_saxbit.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x53996bb917f989a0 ;
    v [0] = 10 ; v [1] = 4 ; v [2] = 0 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
