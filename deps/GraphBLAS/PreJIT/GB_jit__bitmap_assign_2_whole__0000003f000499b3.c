//------------------------------------------------------------------------------
// GB_jit__bitmap_assign_2_whole__0000003f000499b3.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__bitmap_assign_2_whole__0000003f000499b3
#define GB_jit_query  GB_jit__bitmap_assign_2_whole__0000003f000499b3_query
#endif
#include "template/GB_jit_kernel_bitmap_assign_2_whole.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x8ef8ac32bb8688cb ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 0 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
