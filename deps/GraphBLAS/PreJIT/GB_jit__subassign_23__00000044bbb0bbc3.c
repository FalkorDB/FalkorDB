//------------------------------------------------------------------------------
// GB_jit__subassign_23__00000044bbb0bbc3.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__subassign_23__00000044bbb0bbc3
#define GB_jit_query  GB_jit__subassign_23__00000044bbb0bbc3_query
#endif
#include "template/GB_jit_kernel_subassign_23.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x32f9823a38e7b716 ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
