//------------------------------------------------------------------------------
// GB_jit__subref_bitmap__0800cef__LG_MSF_tuple_int64_t.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__subref_bitmap__0800cef__LG_MSF_tuple_int64_t
#define GB_jit_query  GB_jit__subref_bitmap__0800cef__LG_MSF_tuple_int64_t_query
#endif
#include "template/GB_jit_kernel_subref_bitmap.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0xf0b40e5ffc5c1a00 ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
