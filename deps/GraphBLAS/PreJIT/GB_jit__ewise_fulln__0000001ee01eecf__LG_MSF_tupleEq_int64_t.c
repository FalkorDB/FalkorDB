//------------------------------------------------------------------------------
// GB_jit__ewise_fulln__0000001ee01eecf__LG_MSF_tupleEq_int64_t.c
//------------------------------------------------------------------------------
...
// op: LG_MSF_tupleEq_int64_t, ztype: bool, xtype: LG_MSF_tuple_int64_t, ytype: LG_MSF_tuple_int64_t
...
#define GB_X_TYPE LG_MSF_tuple_int64_t
#define GB_Y_TYPE LG_MSF_tuple_int64_t

// binary operator:
#ifndef GB_GUARD_LG_MSF_tupleEq_int64_t_DEFINED
#define GB_GUARD_LG_MSF_tupleEq_int64_t_DEFINED
GB_STATIC_INLINE
void LG_MSF_tupleEq_int64_t ( _Bool *z, const LG_MSF_tuple_int64_t *x, const LG_MSF_tuple_int64_t *y ) { *z = (x->wInt == y->wInt) && (x->idx == y->idx); }
#define GB_LG_MSF_tupleEq_int64_t_USER_DEFN \
"void LG_MSF_tupleEq_int64_t ( _Bool *z, const LG_MSF_tuple_int64_t *x, const LG_MSF_tuple_int64_t *y ) { *z = (x->wInt == y->wInt) && (x->idx == y->idx); }"
#endif
#define GB_BINOP(z,x,y,i,j)  LG_MSF_tupleEq_int64_t (&(z), &(x), &(y))
...
#define GB_A_ISO 0
#define GB_A_TYPE LG_MSF_tuple_int64_t
#define GB_A2TYPE LG_MSF_tuple_int64_t
#define GB_DECLAREA(a) LG_MSF_tuple_int64_t a
...
#define GB_B_ISO 0
#define GB_B_TYPE LG_MSF_tuple_int64_t
#define GB_B2TYPE LG_MSF_tuple_int64_t
#define GB_DECLAREB(b) LG_MSF_tuple_int64_t b
...
#define GB_jit_kernel GB_jit__ewise_fulln__0000001ee01eecf__LG_MSF_tupleEq_int64_t
#define GB_jit_query  GB_jit__ewise_fulln__0000001ee01eecf__LG_MSF_tupleEq_int64_t_query
#endif
#include "template/GB_jit_kernel_ewise_fulln.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0xe15d0ddd049902d9 ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
    defn [0] = GB_LG_MSF_tupleEq_int64_t_USER_DEFN ;
    defn [1] = NULL ;
    defn [2] = NULL ;
    defn [3] = GB_LG_MSF_tuple_int64_t_USER_DEFN ;
    defn [4] = defn [3] ;
    return (true) ;
}
