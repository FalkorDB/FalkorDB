//------------------------------------------------------------------------------
// GB_jit__trans_unop__1848021101b5.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__trans_unop__1848021101b5
#define GB_jit_query  GB_jit__trans_unop__1848021101b5_query
#endif
#include "template/GB_jit_kernel_trans_unop.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x3a7da2aff31b2a8c ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
