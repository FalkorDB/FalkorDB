//------------------------------------------------------------------------------
// GB_jit__apply_bind1st__000000eb90ef9c3__LG_MSF_combine_double.c
//------------------------------------------------------------------------------
...
// op: LG_MSF_combine_double, ztype: LG_MSF_tuple_double, xtype: double, ytype: uint64_t
...
"void LG_MSF_combine_double ( LG_MSF_tuple_double *z, const double *x, const uint64_t *y ) { z->wInt = *x; z->idx = *y; }"
#endif
#define GB_BINOP(z,x,y,i,j)  LG_MSF_combine_double (&(z), &(x), &(y))
...
#define GB_jit_kernel GB_jit__apply_bind1st__000000eb90ef9c3__LG_MSF_combine_double
#define GB_jit_query  GB_jit__apply_bind1st__000000eb90ef9c3__LG_MSF_combine_double_query
#endif
#include "template/GB_jit_kernel_apply_bind1st.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x3fa9cee2a81f260b ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
    defn [0] = GB_LG_MSF_combine_double_USER_DEFN ;
    defn [1] = NULL ;
