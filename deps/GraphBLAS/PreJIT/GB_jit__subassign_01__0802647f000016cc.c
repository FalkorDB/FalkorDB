//------------------------------------------------------------------------------
// GB_jit__subassign_01__0802647f000016cc.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__subassign_01__0802647f000016cc
#define GB_jit_query  GB_jit__subassign_01__0802647f000016cc_query
#endif
#include "template/GB_jit_kernel_subassign_01.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x2ac7b33b64ebf5eb ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
