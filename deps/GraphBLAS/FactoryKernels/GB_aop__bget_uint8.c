...
// accum operator
#define GB_ACCUM_OP(z,x,y) z = GB_bitget_uint8 (x, y)
#define GB_Z_TYPE uint8_t
#define GB_X_TYPE uint8_t
#define GB_Y_TYPE uint8_t
#define GB_DECLAREY(ywork) uint8_t ywork
...
#if (defined(GxB_NO_BGET) || defined(GxB_NO_UINT8) || defined(GxB_NO_BGET_UINT8))
#define GB_DISABLE 1
#else
#define GB_DISABLE 0
#endif
