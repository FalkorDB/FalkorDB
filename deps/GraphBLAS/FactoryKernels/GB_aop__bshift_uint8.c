...
// accum operator
#define GB_ACCUM_OP(z,x,y) z = GB_bitshift_uint8 (x, y)
...
#define GB_DECLAREC(cwork) uint8_t cwork
...
#if (defined(GxB_NO_BSHIFT) || defined(GxB_NO_UINT8) || defined(GxB_NO_BSHIFT_UINT8))
#define GB_DISABLE 1
#else
#define GB_DISABLE 0
#endif
