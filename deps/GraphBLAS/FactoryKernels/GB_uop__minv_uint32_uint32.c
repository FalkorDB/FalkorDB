...
#define GB_UNARYOP(z,x) z = GB_idiv_uint32 (1, x)
...
#if (defined(GxB_NO_MINV) || defined(GxB_NO_UINT32))
#define GB_DISABLE 1
#else
#define GB_DISABLE 0
#endif
...
GrB_Info GB (_uop_apply__minv_uint32_uint32)
(
...
GrB_Info GB (_uop_tran__minv_uint32_uint32)
(
    GrB_Matrix C,
    const GrB_Matrix A,
