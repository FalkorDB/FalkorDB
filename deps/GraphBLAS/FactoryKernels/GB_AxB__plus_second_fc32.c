//------------------------------------------------------------------------------
// GB_AxB__plus_second_fc32.c: matrix multiply for a single semiring
//------------------------------------------------------------------------------
...
// semiring operators:
#define GB_MULTADD(z,a,b,i,k,j) z = GB_FC32_add (z, b)
...
#if (defined(GxB_NO_PLUS) || defined(GxB_NO_SECOND) || defined(GxB_NO_FC32) || defined(GxB_NO_PLUS_FC32) || defined(GxB_NO_SECOND_FC32) || defined(GxB_NO_PLUS_SECOND_FC32))
#define GB_DISABLE 1
#else
#define GB_DISABLE 0
#endif
...
{ 
    ...
    {
        // C = A*B, no mask
        return (GB (_Asaxpy3B_noM__plus_second_fc32) (C, A, B,
