//------------------------------------------------------------------------------
// GB_AxB__min_firsti_int64.c: matrix multiply for a single semiring
//------------------------------------------------------------------------------
...
// semiring operators:
#define GB_MULTADD(z,a,b,i,k,j) { int64_t x_op_y = i ; z = GB_IMIN (z, x_op_y) ; }
...
#if (defined(GxB_NO_MIN) || defined(GxB_NO_FIRSTI) || defined(GxB_NO_INT64) || defined(GxB_NO_MIN_INT64) || defined(GxB_NO_FIRSTI_INT64) || defined(GxB_NO_MIN_FIRSTI_INT64))
#define GB_DISABLE 1
#else
#define GB_DISABLE 0
#endif
...
{ 
    ...
    {
        // C = A*B, no mask
        return (GB (_Asaxpy3B_noM__min_firsti_int64) (C, A, B,
