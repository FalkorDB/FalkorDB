//------------------------------------------------------------------------------
// GB_AxB__times_firsti1_int64.c: matrix multiply for a single semiring
//------------------------------------------------------------------------------
...
// semiring operators:
#define GB_MULTADD(z,a,b,i,k,j) z *= (i+1)
...
#if (defined(GxB_NO_TIMES) || defined(GxB_NO_FIRSTI1) || defined(GxB_NO_INT64) || defined(GxB_NO_TIMES_INT64) || defined(GxB_NO_FIRSTI1_INT64) || defined(GxB_NO_TIMES_FIRSTI1_INT64))
#define GB_DISABLE 1
#else
#define GB_DISABLE 0
#endif
...
{ 
    ...
    {
        // C = A*B, no mask
        return (GB (_Asaxpy3B_noM__times_firsti1_int64) (C, A, B,
            SaxpyTasks, ntasks, nfine, nthreads, do_sort, Werk)) ;
    }
    else if (!Mask_comp)
    {
        // C<M> = A*B
        return (GB (_Asaxpy3B_M__times_firsti1_int64) (C,
    ...
    {
        // C<!M> = A*B
        return (GB (_Asaxpy3B_notM__times_firsti1_int64) (C,
            M, Mask_struct, M_in_place, A, B,
            SaxpyTasks, ntasks, nfine, nthreads, do_sort, Werk)) ;
    }
    #endif
