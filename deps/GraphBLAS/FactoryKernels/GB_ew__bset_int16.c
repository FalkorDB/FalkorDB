...
// operator:
#define GB_BINOP(z,x,y,i,j) z = GB_bitset_int16 (x, y)
...
#if (defined(GxB_NO_BSET) || defined(GxB_NO_INT16) || defined(GxB_NO_BSET_INT16))
#define GB_DISABLE 1
#else
#define GB_DISABLE 0
#endif
...
GrB_Info GB (_Cewise_fulln__bset_int16)
(
    GrB_Matrix C,
    const GrB_Matrix A,
    const GrB_Matrix B,
...
GrB_Info GB (_AunionB__bset_int16)
(
    GrB_Matrix C,
    const int C_sparsity,
    const GrB_Matrix M,
