...
#define GB_UNARYOP(z,x) z = GB_idiv_int8 (1, x)
...
#if (defined(GxB_NO_MINV) || defined(GxB_NO_INT8))
#define GB_DISABLE 1
#else
#define GB_DISABLE 0
#endif
...
GrB_Info GB (_uop_apply__minv_int8_int8)
(
...
GrB_Info GB (_uop_tran__minv_int8_int8)
(
    GrB_Matrix C,
    const GrB_Matrix A,
