//------------------------------------------------------------------------------
// GB_AxB__eq_ge_uint8.c: matrix multiply for a single semiring
//------------------------------------------------------------------------------
...
#if (defined(GxB_NO_EQ) || defined(GxB_NO_GE) || defined(GxB_NO_UINT8) || defined(GxB_NO_EQ_BOOL) || defined(GxB_NO_GE_UINT8) || defined(GxB_NO_EQ_GE_UINT8))
#define GB_DISABLE 1
#else
#define GB_DISABLE 0
#endif
