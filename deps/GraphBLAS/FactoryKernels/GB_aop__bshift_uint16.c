...
// accum operator
#define GB_ACCUM_OP(z,x,y) z = GB_bitshift_uint16 (x, y)
...
#define GB_COPY_aij_to_C(Cx,pC,Ax,pA,A_iso,cwork,C_iso) Cx [pC] = (A_iso) ? cwork : ((int8_t) Ax [pA])
...
#if (defined(GxB_NO_BSHIFT) || defined(GxB_NO_UINT16) || defined(GxB_NO_BSHIFT_UINT16))
#define GB_DISABLE 1
#else
#define GB_DISABLE 0
#endif
