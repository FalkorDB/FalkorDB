//------------------------------------------------------------------------------
// GB_AxB__any_ne_int16.c: matrix multiply for a single semiring
//------------------------------------------------------------------------------
...
#if (defined(GxB_NO_ANY) || defined(GxB_NO_NE) || defined(GxB_NO_INT16) || defined(GxB_NO_ANY_BOOL) || defined(GxB_NO_NE_INT16) || defined(GxB_NO_ANY_NE_INT16))
#define GB_DISABLE 1
#else
#define GB_DISABLE 0
#endif
