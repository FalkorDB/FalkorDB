...
// operator:
#define GB_BINOP(z,x,y,i,j) z = GB_idiv_uint32 (y, x)
...
#if (defined(GxB_NO_RDIV) || defined(GxB_NO_UINT32) || defined(GxB_NO_RDIV_UINT32))
#define GB_DISABLE 1
#else
#define GB_DISABLE 0
#endif
...
GrB_Info GB (_Cewise_fulla__rdiv_uint32)
(
    GrB_Matrix C,
    const GrB_Matrix A,
    const GrB_Matrix B,
...
GrB_Info GB (_Cewise_fulln__rdiv_uint32)
(
    GrB_Matrix C,
    const GrB_Matrix A,
    const GrB_Matrix B,
...
GrB_Info GB (_AunionB__rdiv_uint32)
(
    GrB_Matrix C,
    const int C_sparsity,
    const GrB_Matrix M,
