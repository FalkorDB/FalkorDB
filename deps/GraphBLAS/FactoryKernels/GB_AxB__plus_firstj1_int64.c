...
#if (defined(GxB_NO_PLUS) || defined(GxB_NO_FIRSTJ1) || defined(GxB_NO_INT64) || defined(GxB_NO_PLUS_INT64) || defined(GxB_NO_FIRSTJ1_INT64) || defined(GxB_NO_PLUS_FIRSTJ1_INT64))
#define GB_DISABLE 1
#else
#define GB_DISABLE 0
#endif
