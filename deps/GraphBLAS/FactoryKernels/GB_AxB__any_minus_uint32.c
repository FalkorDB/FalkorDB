...
#if (defined(GxB_NO_ANY) || defined(GxB_NO_MINUS) || defined(GxB_NO_UINT32) || defined(GxB_NO_ANY_UINT32) || defined(GxB_NO_MINUS_UINT32) || defined(GxB_NO_ANY_MINUS_UINT32))
#define GB_DISABLE 1
#else
#define GB_DISABLE 0
#endif
