...
#if (defined(GxB_NO_TIMES) || defined(GxB_NO_RMINUS) || defined(GxB_NO_INT64) || defined(GxB_NO_TIMES_INT64) || defined(GxB_NO_RMINUS_INT64) || defined(GxB_NO_TIMES_RMINUS_INT64))
#define GB_DISABLE 1
#else
#define GB_DISABLE 0
#endif
