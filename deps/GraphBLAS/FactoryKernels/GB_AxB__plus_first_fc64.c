//------------------------------------------------------------------------------
// GB_AxB__plus_first_fc64.c: matrix multiply for a single semiring
//------------------------------------------------------------------------------
...
// semiring operators:
#define GB_MULTADD(z,a,b,i,k,j) z = GB_FC64_add (z, a)
...
#if (defined(GxB_NO_PLUS) || defined(GxB_NO_FIRST) || defined(GxB_NO_FC64) || defined(GxB_NO_PLUS_FC64) || defined(GxB_NO_FIRST_FC64) || defined(GxB_NO_PLUS_FIRST_FC64))
#define GB_DISABLE 1
#else
#define GB_DISABLE 0
#endif
...
{ 
    ...
    {
        // C = A*B, no mask
        return (GB (_Asaxpy3B_noM__plus_first_fc64) (C, A, B,
            SaxpyTasks, ntasks, nfine, nthreads, do_sort, Werk)) ;
    }
    else if (!Mask_comp)
    {
        // C<M> = A*B
        return (GB (_Asaxpy3B_M__plus_first_fc64) (C,
    ...
    {
        // C<!M> = A*B
        return (GB (_Asaxpy3B_notM__plus_first_fc64) (C,
            M, Mask_struct, M_in_place, A, B,
            SaxpyTasks, ntasks, nfine, nthreads, do_sort, Werk)) ;
    }
    #endif
