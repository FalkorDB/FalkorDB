//------------------------------------------------------------------------------
// GB_msort_2_template: sort a 2-by-n list of integers
//------------------------------------------------------------------------------
...
)
{
    ...
    { 
        ...
        bool less = GB_lt_2 (X_0, X_1, pmiddle, Z_0, Z_1, pivot) ;
    ...
    bool found = (pleft == pright) &&
        GB_eq_2 (X_0, X_1, pleft, Z_0, Z_1, pivot) ;
...
static void GB_msort_2_create_merge_tasks
(
    // output:
...
)
{
    ...
    {
        if (GB_lt_2 (L_0, L_1, pleft, R_0, R_1, pright))
        { 
            // S [p] = Left [pleft++]
            S_0 [p] = L_0 [pleft] ;
            S_1 [p] = L_1 [pleft] ;
...
//------------------------------------------------------------------------------
// GB_msort_2_method: parallel mergesort
//------------------------------------------------------------------------------

static GrB_Info GB_msort_2_method    // sort array A of size 2-by-n
(
