//------------------------------------------------------------------------------
// GB_bitmap_assign_8_whole: C bitmap, !M sparse/hyper, no accum
//------------------------------------------------------------------------------
...
)
{
    ...
    GrB_Info info = GB_subassign_jit (C, C_replace,
        ...
        /* S: */ NULL, assign_kind,
        GB_JIT_KERNEL_BITMAP_ASSIGN_8_WHOLE, "bitmap_assign_8_whole",
        Werk) ;
    ...
    #include "assign/template/GB_bitmap_assign_8_whole_template.c"
}
