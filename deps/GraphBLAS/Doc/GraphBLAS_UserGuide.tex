...
\verb'GrB_NAME' and \verb'GrB_ELTYPE_STRING' to the blob in an upward
...
\item Version 9.0.0, Sept 15, 2024
    ...
    \item \verb'GrB_Type_new', \verb'GrB_UnaryOp_new',
        ...
        be used to set the names of the operators.
        These methods no longer extract the name, so the default name is now the
        empty string.  This is because \verb'GrB_get/set' can only set these names
