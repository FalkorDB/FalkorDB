...
{\footnotesize
\begin{verbatim}
GrB_Info GrB_get (GxB_IndexBinaryOp op, GrB_Scalar value, GrB_Field f) ;
GrB_Info GrB_get (GxB_IndexBinaryOp op, char *     value, GrB_Field f) ;
GrB_Info GrB_get (GxB_IndexBinaryOp op, int32_t *  value, GrB_Field f) ;
GrB_Info GrB_get (GxB_IndexBinaryOp op, size_t *   value, GrB_Field f) ;

GrB_Info GrB_set (GxB_IndexBinaryOp op, char *     value, GrB_Field f) ;
\end{verbatim}
}\end{mdframed}
