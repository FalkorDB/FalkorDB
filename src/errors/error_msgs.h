...
#define EMSG_INVALID_CSV_URI "URI to CSV must be a string"
#define EMSG_UNSUPPORTED_CSV_URI "Unsupported URI"
...
#define EMSG_CANT_RUN_ON_GRAPH_WITH_TENSORS "'%s' can't run against a graph containing tensors"
