	...
	while(ftell(stream) < l) {
		...
		switch(t) {
			case EFFECT_DELETE_NODE:
				ApplyDeleteNode_V2(stream, gc);
				break;
			case EFFECT_DELETE_EDGE:
				ApplyDeleteEdge_V2(stream, gc);
				break;
			case EFFECT_UPDATE_NODE:
				ApplyUpdateNode_V2(stream, gc);
				break;
			case EFFECT_UPDATE_EDGE:
				ApplyUpdateEdge_V2(stream, gc);
				break;
			case EFFECT_CREATE_NODE:    
				ApplyCreateNode_V2(stream, gc);
				break;
			case EFFECT_CREATE_EDGE:
				ApplyCreateEdge_V2(stream, gc);
				break;
			...
			case EFFECT_ADD_SCHEMA:
				ApplyAddSchema_V2(stream, gc);
				break;
			case EFFECT_ADD_ATTRIBUTE:
				ApplyAddAttribute_V2(stream, gc);
				break;
			default:
