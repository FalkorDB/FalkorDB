...
(
	...
	Delta_Matrix M = Graph_GetRelationMatrix(gc->g, r, false);
	Delta_Matrix ME = Graph_MultiEdgeRelationMatrix(gc->g, r);
...
finish:
	...
	GraphEncodeContext_SetMutipleEdges(gc->encoding_context, src, dest);
}