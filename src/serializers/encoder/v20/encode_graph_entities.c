...
static inline void _RdbSaveDeletedEntities_v20
(
...
(
	...
	_RdbSaveDeletedEntities_v20(rdb, n, offset, deleted_nodes_list);
}

// encode deleted edges IDs
void RdbSaveDeletedEdges_v20
(
	SerializerIO rdb,  // RDB
	GraphContext *gc,  // graph context
	uint64_t offset,   // offset
	...
	_RdbSaveDeletedEntities_v20(rdb, n, offset, deleted_edges_list);
}

// encode graph entities
static void _SaveEntities_v20
(
	SerializerIO rdb,         // RDB
	GraphContext *gc,         // graph context
...
(
	...
	_SaveEntities_v20(rdb, gc, iter, n);
