...
void Register_PointFuncs() {
	...
	func_desc = AR_FuncDescNew("point", AR_TOPOINT, 1, 1, types, ret_type, false, true, "create a point");
	...
	func_desc = AR_FuncDescNew("distance", AR_DISTANCE, 2, 2, types, ret_type, false, true, "distance between two points");
	AR_RegFunc(func_desc);
}
