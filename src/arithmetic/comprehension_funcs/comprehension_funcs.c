...
void Register_ComprehensionFuncs() {
	...
	func_desc = AR_FuncDescNew("any", AR_ANY, 2, 2, types, ret_type, true, true,"ANY comprehension");
	...
	array_append(types, T_ARRAY | T_NULL);
	array_append(types, T_PTR);
	func_desc = AR_FuncDescNew("all", AR_ALL, 2, 2, types, ret_type, true, true, "ALL comprehension");
	AR_SetPrivateDataRoutines(func_desc, ListComprehension_Free, ListComprehension_Clone);
	AR_RegFunc(func_desc);
	...
	array_append(types, T_ARRAY | T_NULL);
	array_append(types, T_PTR);
	func_desc = AR_FuncDescNew("single", AR_SINGLE, 2, 2, types, ret_type, true, true, "SINGLE comprehension");
	AR_SetPrivateDataRoutines(func_desc, ListComprehension_Free, ListComprehension_Clone);
	AR_RegFunc(func_desc);
	...
	array_append(types, T_ARRAY | T_NULL);
	array_append(types, T_PTR);
	func_desc = AR_FuncDescNew("none", AR_NONE, 2, 2, types, ret_type, true, true, "NONE comprehension");
	AR_SetPrivateDataRoutines(func_desc, ListComprehension_Free, ListComprehension_Clone);
	AR_RegFunc(func_desc);
