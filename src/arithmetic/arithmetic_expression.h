...
// compact tree by evaluating all contained functions
// that can be resolved right now the function returns true if it managed to
// compact the expression the reduce_params flag indicates if parameters should
// be evaluated the val pointer is out-by-ref returned computation
