...
// the Merge operation accepts exactly one path in the query and attempts to
// match it if the path is not found, it will be created, making new instances
// of every path variable not bound in an earlier clause in the query
typedef struct {
	OpBase op;                      // base op
