...
- **On a PR** (from a branch in this repo — a fork PR's read-only token can't
  ...
  **accumulate** across sizes into one published view and one PR comment.
  ...
  Published to
  `https://falkordb.github.io/FalkorDB/benchmark/branch/pr-<N>/`
...
- **Automatically**: every time `edge-rs` is promoted (merge to main), the
  canonical trend at
  [`/benchmark/`](https://falkordb.github.io/FalkorDB/benchmark/)
  ...
  [`/benchmark/trend/`](https://falkordb.github.io/FalkorDB/benchmark/trend/).
