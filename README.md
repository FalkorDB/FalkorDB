...
>On Ubuntu Linux, run: `apt-get install build-essential cmake m4 automake peg libtool autoconf python3 python3-pip libssl-dev`
>
>when your python3 --version says < 3.7 write:
>
