//------------------------------------------------------------------------------
// GB_jit__AxB_dot4__0380800eb90eb9c3__LG_MSF_tupleMin_double_LG_MSF_combine_double.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__AxB_dot4__0380800eb90eb9c3__LG_MSF_tupleMin_double_LG_MSF_combine_double
#define GB_jit_query  GB_jit__AxB_dot4__0380800eb90eb9c3__LG_MSF_tupleMin_double_LG_MSF_combine_double_query
#endif
#include "template/GB_jit_kernel_AxB_dot4.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0xa3dbe89150d6d788 ;
    v [0] = 10 ; v [1] = 5 ; v [2] = 0 ;
