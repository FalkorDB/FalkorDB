//------------------------------------------------------------------------------
// GB_jit__masker_phase2__1f805197.c
//------------------------------------------------------------------------------
...
#define GB_Z_IS_FULL   1
#define GBp_Z(Zp,k,vlen) ((k) * (vlen))
#define GBh_Z(Zh,k)      (k)
#define GBi_Z(Zi,p,vlen) ((p) % (vlen))
#define GBb_Z(Zb,p)      1
#define GB_Z_NVALS(e) int64_t e = (Z->vlen * Z->vdim)
...
#define GB_jit_kernel GB_jit__masker_phase2__1f805197
#define GB_jit_query  GB_jit__masker_phase2__1f805197_query
#endif
#include "template/GB_jit_kernel_masker_phase2.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x9118ed535a5d191d ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
