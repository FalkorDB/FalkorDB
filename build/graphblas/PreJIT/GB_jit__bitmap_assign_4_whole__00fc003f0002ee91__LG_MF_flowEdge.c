//------------------------------------------------------------------------------
// GB_jit__bitmap_assign_4_whole__00fc003f0002ee91__LG_MF_flowEdge.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__bitmap_assign_4_whole__00fc003f0002ee91__LG_MF_flowEdge
#define GB_jit_query  GB_jit__bitmap_assign_4_whole__00fc003f0002ee91__LG_MF_flowEdge_query
#endif
#include "template/GB_jit_kernel_bitmap_assign_4_whole.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x77225e3522bb573b ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
