//------------------------------------------------------------------------------
// GB_jit__convert_s2b__03c002ee0eec__LG_MF_compareTuple32.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__convert_s2b__03c002ee0eec__LG_MF_compareTuple32
#define GB_jit_query  GB_jit__convert_s2b__03c002ee0eec__LG_MF_compareTuple32_query
#endif
#include "template/GB_jit_kernel_convert_s2b.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0xd7d18db4ed1ce84f ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
