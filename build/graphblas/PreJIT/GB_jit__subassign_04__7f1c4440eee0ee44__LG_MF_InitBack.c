//------------------------------------------------------------------------------
// GB_jit__subassign_04__7f1c4440eee0ee44__LG_MF_InitBack.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__subassign_04__7f1c4440eee0ee44__LG_MF_InitBack
#define GB_jit_query  GB_jit__subassign_04__7f1c4440eee0ee44__LG_MF_InitBack_query
#endif
#include "template/GB_jit_kernel_subassign_04.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x1ad625a39aa487ee ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
