//------------------------------------------------------------------------------
// GB_jit__bitmap_assign_8_whole__00e0803f0003bb92.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__bitmap_assign_8_whole__00e0803f0003bb92
#define GB_jit_query  GB_jit__bitmap_assign_8_whole__00e0803f0003bb92_query
#endif
#include "template/GB_jit_kernel_bitmap_assign_8_whole.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0xe3e2a5bd9e781d0f ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
