//------------------------------------------------------------------------------
// GB_jit__convert_b2s__104002880866.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__convert_b2s__104002880866
#define GB_jit_query  GB_jit__convert_b2s__104002880866_query
#endif
#include "template/GB_jit_kernel_convert_b2s.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x47b4d35c2ba19792 ;
    v [0] = 10 ; v [1] = 5 ; v [2] = 0 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
