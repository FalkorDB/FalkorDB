//------------------------------------------------------------------------------
// GB_jit__AxB_dot4__0000400e1e0e1eca__lg_hll_merge_lg_hll_second.c
//------------------------------------------------------------------------------
...
GB_STATIC_INLINE
void lg_hll_second(HLL *z, _Bool *x, const HLL *y) { __builtin___memcpy_chk (z->registers, y->registers, sizeof(z->registers), __builtin_object_size (z->registers, 0)); }
...
#define GB_jit_kernel GB_jit__AxB_dot4__0000400e1e0e1eca__lg_hll_merge_lg_hll_second
#define GB_jit_query  GB_jit__AxB_dot4__0000400e1e0e1eca__lg_hll_merge_lg_hll_second_query
#endif
#include "template/GB_jit_kernel_AxB_dot4.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x4a73b2409acd26c8 ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
