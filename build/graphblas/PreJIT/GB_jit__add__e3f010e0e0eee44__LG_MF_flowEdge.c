//------------------------------------------------------------------------------
// GB_jit__add__e3f010e0e0eee44__LG_MF_flowEdge.c
//------------------------------------------------------------------------------
...
// op: 2nd_LG_MF_flowEdge, ztype: LG_MF_flowEdge, xtype: LG_MF_flowEdge, ytype: LG_MF_flowEdge
...
#define GB_B_ISO 0
#define GB_B_TYPE LG_MF_flowEdge
#define GB_B2TYPE LG_MF_flowEdge
#define GB_DECLAREB(b) LG_MF_flowEdge b
...
#define GB_jit_kernel GB_jit__add__e3f010e0e0eee44__LG_MF_flowEdge
#define GB_jit_query  GB_jit__add__e3f010e0e0eee44__LG_MF_flowEdge_query
#endif
#include "template/GB_jit_kernel_add.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0xf4e67ede328a5b73 ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
