//------------------------------------------------------------------------------
// GB_jit__AxB_dot4__0000800eb90eb9cb__LG_MSF_tupleMin_double_LG_MSF_combine_double.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__AxB_dot4__0000800eb90eb9cb__LG_MSF_tupleMin_double_LG_MSF_combine_double
#define GB_jit_query  GB_jit__AxB_dot4__0000800eb90eb9cb__LG_MSF_tupleMin_double_LG_MSF_combine_double_query
#endif
#include "template/GB_jit_kernel_AxB_dot4.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x49864d4cef2ba045 ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
