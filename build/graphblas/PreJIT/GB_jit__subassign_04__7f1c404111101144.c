//------------------------------------------------------------------------------
// GB_jit__subassign_04__7f1c404111101144.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__subassign_04__7f1c404111101144
#define GB_jit_query  GB_jit__subassign_04__7f1c404111101144_query
#endif
#include "template/GB_jit_kernel_subassign_04.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x5ea1407e3ccc0d1d ;
    v [0] = 10 ; v [1] = 5 ; v [2] = 0 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
