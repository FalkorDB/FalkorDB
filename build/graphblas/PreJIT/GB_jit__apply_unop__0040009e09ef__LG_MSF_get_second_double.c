//------------------------------------------------------------------------------
// GB_jit__apply_unop__0040009e09ef__LG_MSF_get_second_double.c
//------------------------------------------------------------------------------
...
// op: LG_MSF_get_second_double, ztype: uint64_t, xtype: LG_MSF_tuple_double, ytype: void
...
// unary operator:
#ifndef GB_GUARD_LG_MSF_get_second_double_DEFINED
#define GB_GUARD_LG_MSF_get_second_double_DEFINED
GB_STATIC_INLINE
void LG_MSF_get_second_double (uint64_t *y, const LG_MSF_tuple_double *x){ *y = x->idx; }
#define GB_LG_MSF_get_second_double_USER_DEFN \
"void LG_MSF_get_second_double (uint64_t *y, const LG_MSF_tuple_double *x){ *y = x->idx; }"
#endif
#define GB_UNARYOP(z,x,i,j,y)  LG_MSF_get_second_double (&(z), &(x))
...
#define GB_jit_kernel GB_jit__apply_unop__0040009e09ef__LG_MSF_get_second_double
#define GB_jit_query  GB_jit__apply_unop__0040009e09ef__LG_MSF_get_second_double_query
#endif
#include "template/GB_jit_kernel_apply_unop.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0xac3fbffbeb9a27bb ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
    defn [0] = GB_LG_MSF_get_second_double_USER_DEFN ;
    defn [1] = NULL ;
    defn [2] = NULL ;
