//------------------------------------------------------------------------------
// GB_jit__rowscale__010200e1e0e1ec7__LG_MSF_tuple2nd_double.c
//------------------------------------------------------------------------------
...
// op: LG_MSF_tuple2nd_double, ztype: LG_MSF_tuple_double, xtype: bool, ytype: LG_MSF_tuple_double
...
"void LG_MSF_tuple2nd_double ( LG_MSF_tuple_double *z, const void *x, const LG_MSF_tuple_double *y ) { z->wInt = y->wInt; z->idx = y->idx; }"
#endif
#define GB_BINOP(z,x,y,i,j)  LG_MSF_tuple2nd_double (&(z), &(x), &(y))
...
#define GB_jit_kernel GB_jit__rowscale__010200e1e0e1ec7__LG_MSF_tuple2nd_double
#define GB_jit_query  GB_jit__rowscale__010200e1e0e1ec7__LG_MSF_tuple2nd_double_query
#endif
#include "template/GB_jit_kernel_rowscale.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x2f38f8d80ee55d47 ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
    defn [0] = GB_LG_MSF_tuple2nd_double_USER_DEFN ;
    defn [1] = NULL ;
