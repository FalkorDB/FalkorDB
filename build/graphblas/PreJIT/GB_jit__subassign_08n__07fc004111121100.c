//------------------------------------------------------------------------------
// GB_jit__subassign_08n__07fc004111121100.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__subassign_08n__07fc004111121100
#define GB_jit_query  GB_jit__subassign_08n__07fc004111121100_query
#endif
#include "template/GB_jit_kernel_subassign_08n.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0xde1ff1632c8a6ffe ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
