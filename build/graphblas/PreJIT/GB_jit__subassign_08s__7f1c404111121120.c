//------------------------------------------------------------------------------
// GB_jit__subassign_08s__7f1c404111121120.c
//------------------------------------------------------------------------------
...
// subassign: C<M,bitmap,struct> any= A 
...
#define GB_jit_kernel GB_jit__subassign_08s__7f1c404111121120
#define GB_jit_query  GB_jit__subassign_08s__7f1c404111121120_query
#endif
#include "template/GB_jit_kernel_subassign_08s.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x7e477fa01c090bd2 ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
