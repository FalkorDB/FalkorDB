//------------------------------------------------------------------------------
// GB_jit__select_phase2__3f0c108e5.c
//------------------------------------------------------------------------------
...
#define GB_IDXUNOP(z,x,i,j,y) z = (i >= 0)
...
#define GB_jit_kernel GB_jit__select_phase2__3f0c108e5
#define GB_jit_query  GB_jit__select_phase2__3f0c108e5_query
#endif
#include "template/GB_jit_kernel_select_phase2.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x693e5c1eed6c29de ;
    v [0] = 10 ; v [1] = 5 ; v [2] = 0 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
