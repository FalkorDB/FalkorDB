//------------------------------------------------------------------------------
// GB_jit__subref_bitmap__0808c1f.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__subref_bitmap__0808c1f
#define GB_jit_query  GB_jit__subref_bitmap__0808c1f_query
#endif
#include "template/GB_jit_kernel_subref_bitmap.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x35de9e367d98ab6b ;
    v [0] = 10 ; v [1] = 5 ; v [2] = 0 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
