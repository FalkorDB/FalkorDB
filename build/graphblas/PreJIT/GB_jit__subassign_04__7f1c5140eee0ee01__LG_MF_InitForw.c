//------------------------------------------------------------------------------
// GB_jit__subassign_04__7f1c5140eee0ee01__LG_MF_InitForw.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__subassign_04__7f1c5140eee0ee01__LG_MF_InitForw
#define GB_jit_query  GB_jit__subassign_04__7f1c5140eee0ee01__LG_MF_InitForw_query
#endif
#include "template/GB_jit_kernel_subassign_04.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x55f5286363fb2a5f ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
