//------------------------------------------------------------------------------
// GB_jit__emult_04__fc0214bbb2bbb5f.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__emult_04__fc0214bbb2bbb5f
#define GB_jit_query  GB_jit__emult_04__fc0214bbb2bbb5f_query
#endif
#include "template/GB_jit_kernel_emult_04.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x0956ee84bc2c7349 ;
    v [0] = 10 ; v [1] = 5 ; v [2] = 0 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
