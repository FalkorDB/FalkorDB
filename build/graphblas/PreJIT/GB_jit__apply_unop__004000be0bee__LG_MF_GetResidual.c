//------------------------------------------------------------------------------
// GB_jit__apply_unop__004000be0bee__LG_MF_GetResidual.c
//------------------------------------------------------------------------------
...
// op: LG_MF_GetResidual, ztype: double, xtype: LG_MF_flowEdge, ytype: void
...
// unary operator:
#ifndef GB_GUARD_LG_MF_GetResidual_DEFINED
#define GB_GUARD_LG_MF_GetResidual_DEFINED
GB_STATIC_INLINE
void LG_MF_GetResidual(double * res, const LG_MF_flowEdge * flow_edge){ (*res) = flow_edge->capacity - flow_edge->flow; }
#define GB_LG_MF_GetResidual_USER_DEFN \
"void LG_MF_GetResidual(double * res, const LG_MF_flowEdge * flow_edge){ (*res) = flow_edge->capacity - flow_edge->flow; }"
#endif
#define GB_UNARYOP(z,x,i,j,y)  LG_MF_GetResidual (&(z), &(x))
...
#define GB_jit_kernel GB_jit__apply_unop__004000be0bee__LG_MF_GetResidual
#define GB_jit_query  GB_jit__apply_unop__004000be0bee__LG_MF_GetResidual_query
#endif
#include "template/GB_jit_kernel_apply_unop.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x826d3be4f96d177a ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
    defn [0] = GB_LG_MF_GetResidual_USER_DEFN ;
    defn [1] = NULL ;
    defn [2] = NULL ;
