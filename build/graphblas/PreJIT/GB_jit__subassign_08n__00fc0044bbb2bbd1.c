//------------------------------------------------------------------------------
// GB_jit__subassign_08n__00fc0044bbb2bbd1.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__subassign_08n__00fc0044bbb2bbd1
#define GB_jit_query  GB_jit__subassign_08n__00fc0044bbb2bbd1_query
#endif
#include "template/GB_jit_kernel_subassign_08n.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0xdca3afc3945a706a ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
