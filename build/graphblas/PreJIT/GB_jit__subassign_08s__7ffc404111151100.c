//------------------------------------------------------------------------------
// GB_jit__subassign_08s__7ffc404111151100.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__subassign_08s__7ffc404111151100
#define GB_jit_query  GB_jit__subassign_08s__7ffc404111151100_query
#endif
#include "template/GB_jit_kernel_subassign_08s.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0xe6c65995c0a53675 ;
    v [0] = 10 ; v [1] = 5 ; v [2] = 0 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
