//------------------------------------------------------------------------------
// GB_jit__AxB_saxbit__038420fbb00bb087.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__AxB_saxbit__038420fbb00bb087
#define GB_jit_query  GB_jit__AxB_saxbit__038420fbb00bb087_query
#endif
#include "template/GB_jit_kernel_AxB_saxbit.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x9924918fe7e61f8c ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
