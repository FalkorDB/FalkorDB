//------------------------------------------------------------------------------
// GB_jit__apply_unop__0040006e06ee__LG_MF_ExtractYJ32.c
//------------------------------------------------------------------------------
...
// op: LG_MF_ExtractYJ32, ztype: int32_t, xtype: LG_MF_resultTuple32, ytype: void
...
// unary operator:
#ifndef GB_GUARD_LG_MF_ExtractYJ32_DEFINED
#define GB_GUARD_LG_MF_ExtractYJ32_DEFINED
GB_STATIC_INLINE
void LG_MF_ExtractYJ32(int32_t *z, const LG_MF_resultTuple32 *x) { (*z) = x->j; }
#define GB_LG_MF_ExtractYJ32_USER_DEFN \
"void LG_MF_ExtractYJ32(int32_t *z, const LG_MF_resultTuple32 *x) { (*z) = x->j; }"
#endif
#define GB_UNARYOP(z,x,i,j,y)  LG_MF_ExtractYJ32 (&(z), &(x))
...
#define GB_jit_kernel GB_jit__apply_unop__0040006e06ee__LG_MF_ExtractYJ32
#define GB_jit_query  GB_jit__apply_unop__0040006e06ee__LG_MF_ExtractYJ32_query
#endif
#include "template/GB_jit_kernel_apply_unop.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x6e293d6e223a7b4b ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
    defn [0] = GB_LG_MF_ExtractYJ32_USER_DEFN ;
    defn [1] = NULL ;
    defn [2] = NULL ;
