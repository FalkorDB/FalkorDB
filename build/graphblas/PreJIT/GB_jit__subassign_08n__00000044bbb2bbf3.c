//------------------------------------------------------------------------------
// GB_jit__subassign_08n__00000044bbb2bbf3.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__subassign_08n__00000044bbb2bbf3
#define GB_jit_query  GB_jit__subassign_08n__00000044bbb2bbf3_query
#endif
#include "template/GB_jit_kernel_subassign_08n.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0xfb665f116388e753 ;
    v [0] = 10 ; v [1] = 5 ; v [2] = 0 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
