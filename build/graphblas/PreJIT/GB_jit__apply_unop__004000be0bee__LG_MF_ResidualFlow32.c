//------------------------------------------------------------------------------
// GB_jit__apply_unop__004000be0bee__LG_MF_ResidualFlow32.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__apply_unop__004000be0bee__LG_MF_ResidualFlow32
#define GB_jit_query  GB_jit__apply_unop__004000be0bee__LG_MF_ResidualFlow32_query
#endif
#include "template/GB_jit_kernel_apply_unop.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x507bcbe911279eef ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
