//------------------------------------------------------------------------------
// GB_jit__subref_sparse__0bf0015.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__subref_sparse__0bf0015
#define GB_jit_query  GB_jit__subref_sparse__0bf0015_query
#endif
#include "template/GB_jit_kernel_subref_sparse.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0xf34279ef2ea9ce72 ;
    v [0] = 10 ; v [1] = 5 ; v [2] = 0 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
