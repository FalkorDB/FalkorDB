...
// op: LG_MSF_tupleEq_double, ztype: bool, xtype: LG_MSF_tuple_double, ytype: LG_MSF_tuple_double
...
// binary operator:
#ifndef GB_GUARD_LG_MSF_tupleEq_double_DEFINED
#define GB_GUARD_LG_MSF_tupleEq_double_DEFINED
GB_STATIC_INLINE
void LG_MSF_tupleEq_double ( _Bool *z, const LG_MSF_tuple_double *x, const LG_MSF_tuple_double *y ) { *z = (x->wInt == y->wInt) && (x->idx == y->idx); }
#define GB_LG_MSF_tupleEq_double_USER_DEFN \
"void LG_MSF_tupleEq_double ( _Bool *z, const LG_MSF_tuple_double *x, const LG_MSF_tuple_double *y ) { *z = (x->wInt == y->wInt) && (x->idx == y->idx); }"
#endif
#define GB_BINOP(z,x,y,i,j)  LG_MSF_tupleEq_double (&(z), &(x), &(y))
...
#define GB_jit_kernel GB_jit__ewise_fulln__0000001ee01eecf__LG_MSF_tupleEq_double
#define GB_jit_query  GB_jit__ewise_fulln__0000001ee01eecf__LG_MSF_tupleEq_double_query
#endif
...
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    ...
    defn [1] = NULL ;
    defn [2] = NULL ;
    defn [3] = GB_LG_MSF_tuple_double_USER_DEFN ;
    defn [4] = defn [3] ;
    return (true) ;
}
