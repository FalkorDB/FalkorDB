//------------------------------------------------------------------------------
// GB_jit__masker_phase1__dff35041.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__masker_phase1__dff35041
#define GB_jit_query  GB_jit__masker_phase1__dff35041_query
#endif
#include "template/GB_jit_kernel_masker_phase1.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x165e712ad9bc7742 ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
    defn [2] = NULL ;
