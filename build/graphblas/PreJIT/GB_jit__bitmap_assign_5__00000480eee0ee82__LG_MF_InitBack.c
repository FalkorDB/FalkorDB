//------------------------------------------------------------------------------
// GB_jit__bitmap_assign_5__00000480eee0ee82__LG_MF_InitBack.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__bitmap_assign_5__00000480eee0ee82__LG_MF_InitBack
#define GB_jit_query  GB_jit__bitmap_assign_5__00000480eee0ee82__LG_MF_InitBack_query
#endif
#include "template/GB_jit_kernel_bitmap_assign_5.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0xd2cd669853171b95 ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
