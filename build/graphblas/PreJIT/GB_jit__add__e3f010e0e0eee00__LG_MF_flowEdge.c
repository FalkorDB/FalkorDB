//------------------------------------------------------------------------------
// GB_jit__add__e3f010e0e0eee00__LG_MF_flowEdge.c
//------------------------------------------------------------------------------
...
#define GB_jit_kernel GB_jit__add__e3f010e0e0eee00__LG_MF_flowEdge
#define GB_jit_query  GB_jit__add__e3f010e0e0eee00__LG_MF_flowEdge_query
#endif
#include "template/GB_jit_kernel_add.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x56563813b4385009 ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
    defn [0] = NULL ;
    defn [1] = NULL ;
