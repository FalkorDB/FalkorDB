//------------------------------------------------------------------------------
// GB_jit__emult_bitmap__00000066e266eae__LG_MF_Relabel32.c
//------------------------------------------------------------------------------
...
// op: LG_MF_Relabel32, ztype: int32_t, xtype: int32_t, ytype: LG_MF_resultTuple32
...
#define GB_Y_TYPE LG_MF_resultTuple32

// binary operator:
#ifndef GB_GUARD_LG_MF_Relabel32_DEFINED
#define GB_GUARD_LG_MF_Relabel32_DEFINED
GB_STATIC_INLINE
void LG_MF_Relabel32(int32_t *z, const int32_t *x, const LG_MF_resultTuple32 *y) { if((*x) < y->d+1){ (*z) = y->d + 1; } else { (*z) = (*x); } }
#define GB_LG_MF_Relabel32_USER_DEFN \
"void LG_MF_Relabel32(int32_t *z, const int32_t *x, const LG_MF_resultTuple32 *y) { if((*x) < y->d+1){ (*z) = y->d + 1; } else { (*z) = (*x); } }"
#endif
#define GB_BINOP(z,x,y,i,j)  LG_MF_Relabel32 (&(z), &(x), &(y))
...
#define GB_DECLAREA(a) int32_t a
...
#define GB_B_ISO 0
#define GB_B_TYPE LG_MF_resultTuple32
#define GB_B2TYPE LG_MF_resultTuple32
#define GB_DECLAREB(b) LG_MF_resultTuple32 b
...
#define GB_jit_kernel GB_jit__emult_bitmap__00000066e266eae__LG_MF_Relabel32
#define GB_jit_query  GB_jit__emult_bitmap__00000066e266eae__LG_MF_Relabel32_query
#endif
#include "template/GB_jit_kernel_emult_bitmap.c"
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query) ;
GB_JIT_GLOBAL GB_JIT_QUERY_PROTO (GB_jit_query)
{
    (*hash) = 0x056848c93f34c316 ;
    v [0] = 10 ; v [1] = 3 ; v [2] = 1 ;
    defn [0] = GB_LG_MF_Relabel32_USER_DEFN ;
    defn [1] = NULL ;
    defn [2] = NULL ;
    defn [3] = NULL ;
    defn [4] = GB_LG_MF_resultTuple32_USER_DEFN ;
    return (true) ;
}
